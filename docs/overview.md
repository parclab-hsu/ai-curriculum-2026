...
> 2024·2025·2026년 **기술 트렌드**와 **직무 역량 수요**를 데이터로 도출하고 추세선(선형회귀)으로 분석한 리포트. 데이터 기준 2026-06.

## 1. 핵심 결론

**기술은 `생성형 AI(2024) → 에이전트 AI(2025) → Physical AI(2026)`로 이동하고, 직무 시장은 `AI 활용 역량`을 가장 가파른 기울기로 요구한다.** 두 추세선의 교차점에 PARC Lab의 도메인(Physical AI·로봇·모빌리티 실시간 제어)이 정확히 위치한다.
...
| 연도 | Gartner 최상위 트렌드 | 키워드 | 직무 시장 신호 |
|---|---|---|---|
