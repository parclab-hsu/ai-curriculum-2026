...
```mermaid
flowchart LR
  M1["① AI·데이터 공통 기초<br/>컴퓨터프로그래밍 · 프로그래밍랩 · 확률및통계"] --> CAP
  M2["② 컴퓨터과학 기반<br/>자료구조 · 컴퓨터구조 · 알고리즘"] --> CAP
  M3["③ 소프트웨어공학 기반<br/>객체지향언어1 · 객체지향언어2 · 소프트웨어공학"] --> CAP
  M4["④ 모바일 앱 개발<br/>안드로이드프로그래밍 · 고급모바일프로그래밍 · iOS프로그래밍"] --> CAP
  M5["⑤ 온디바이스 AI<br/>데이터마이닝 · 컴퓨터비젼 · 모바일시스템응용프로젝트"] --> CAP
  M6["⑥ 생성형 AI 모바일 서비스<br/>네트워크프로그래밍 · 웹서버프로그래밍 · 생성형AI앱개발"] --> CAP
  CAP["종합설계 · 모바일 캡스톤디자인"]
```
