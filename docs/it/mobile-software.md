...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Engineering/4889/subview.do](https://www.hansung.ac.kr/Engineering/4889/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.

| 모듈명 | 계층 | 핵심 역량·주제 | 학습 성과 | 대표 교과(공식 3~4과목) |
| --- | --- | --- | --- | --- |
| ① AI·데이터 공통 기초 | 단과대학공통 | Python·데이터 처리, 생성형 AI/LLM 활용, AI 코딩 어시스턴트, AI 윤리 | AI 도구로 데이터 처리·프로토타이핑 수행 | 컴퓨터프로그래밍 · 프로그래밍랩 · 확률및통계 · AI를 이용한 주식가치평가 |
...
| ④ 모바일 앱 개발 | 트랙전공 | 안드로이드/iOS·Flutter, 모바일 UI/UX, 앱 아키텍처 | 스토어 배포 가능한 앱 독립 구현 | 모바일&스마트시스템 · 안드로이드프로그래밍 · 고급모바일프로그래밍 · iOS프로그래밍 |
| ⑤ 온디바이스 AI | 트랙전공 | 모델 경량화·양자화, TFLite/Core ML, 엣지 추론 | 단말 내 실시간 AI 기능 탑재 | 데이터마이닝 · 컴퓨터비젼 · 모바일시스템응용프로젝트 · 온디바이스AI(예시) |
| ⑥ 생성형 AI 모바일 서비스 | 트랙전공 | LLM API·sLM, RAG, 멀티모달 연동 | 대화형 AI 모바일 앱 구현 | 네트워크프로그래밍 · 웹서버프로그래밍 · 생성형AI앱개발(예시) · 모바일AI서비스(예시) |
| ⑦ 모바일 캡스톤 | 트랙전공 | 기획·개발·배포·운영, 산학 협업 | AI 모바일 서비스 종합 완성 | 모바일 캡스톤디자인 · 기업연계 SW캡스톤디자인 · 융합캡스톤디자인 |
...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["프로그래밍 입문<br/>컴퓨터프로그래밍 · 프로그래밍랩"]
    M1["① AI·데이터 공통 기초<br/>확률및통계 · AI를 이용한 주식가치평가"]
    M2["② 컴퓨터과학 기반<br/>자료구조 · 컴퓨터구조"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M3["③ 소프트웨어공학 기반<br/>객체지향언어1 · 소프트웨어공학"]
    M4["④ 모바일 앱 개발<br/>안드로이드프로그래밍 · iOS프로그래밍"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M5["⑤ 온디바이스 AI<br/>데이터마이닝 · 컴퓨터비젼"]
    M6["⑥ 생성형 AI 모바일 서비스<br/>네트워크프로그래밍 · 생성형AI앱개발"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["⑦ 모바일 캡스톤<br/>모바일 캡스톤디자인 · 기업연계 SW캡스톤디자인"]
  end
  A0 --> M2 --> M3 --> M4 --> M5 --> M6 --> CAP
  M1 --> M6
```
...
| --- | --- | --- |
| ① AI·데이터 공통 기초 | Python·데이터 처리, 생성형 AI/LLM 활용, AI 코딩 어시스턴트, AI 윤리 | (AI 융합) AI 리터러시, AI 코딩 어시스턴트(Copilot·Claude Code·Cursor) |
| ② 컴퓨터과학 기반 | 자료구조, 알고리즘, 운영체제, 네트워크 | (핵심 직무) 코딩테스트/CS(알고리즘·자료구조) |
| ③ 소프트웨어공학 기반 | 객체지향, 협업·형상관리, 테스트 | (핵심 직무) 문제 해결력(코드 구조 설계·오류 분석), 협업·문서화 |
| ④ 모바일 앱 개발 | 안드로이드/iOS·Flutter, 모바일 UI/UX, 앱 아키텍처 | (기술스택) Kotlin·Jetpack Compose / Swift·SwiftUI / Flutter·KMP |
| ⑤ 온디바이스 AI | 모델 경량화·양자화, TFLite/Core ML, 엣지 추론 | (AI 융합) 온디바이스 AI(Gemini Nano·ML Kit GenAI·AICore / Foundation Models) / (기술스택) ExecuTorch |
| ⑥ 생성형 AI 모바일 서비스 | LLM API·sLM, RAG, 멀티모달 연동 | (AI 융합) 생성형 AI/LLM 연동 / (기술스택) Apple Foundation Models·Gemini Nano |
| ⑦ 모바일 캡스톤 | 기획·개발·배포·운영, 산학 협업 | (핵심 직무) 배포·운영(CI/CD, 스토어 출시), 협업·문서화 |
