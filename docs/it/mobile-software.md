...
| --- | --- | --- | --- | --- |
| AI·데이터 공통 기초 | 단과대학공통 | Python·데이터 처리, 생성형 AI/LLM 활용, AI 코딩 어시스턴트, AI 윤리 | AI 도구로 데이터 처리·프로토타이핑 수행 | 컴퓨터프로그래밍, 확률및통계, 선형대수; AI·데이터 리터러시(제안) |
| 컴퓨터과학 기반 | 학부공통 | 자료구조, 알고리즘, 운영체제, 네트워크 | 시스템 동작 원리 이해 및 효율적 알고리즘 설계 | 자료구조, 컴퓨터구조, 데이터통신 |
| 소프트웨어공학 기반 | 학부공통 | 객체지향, 협업·형상관리, 테스트 | 협업 기반 SW 개발 프로세스 수행 | 객체지향언어1, 객체지향언어2, 프로그래밍언어론; 소프트웨어공학(제안) |
| 모바일 앱 개발 | 트랙전공 | 안드로이드/iOS·Flutter, 모바일 UI/UX, 앱 아키텍처 | 스토어 배포 가능한 앱 독립 구현 | 모바일&스마트시스템, 안드로이드프로그래밍, 고급모바일프로그래밍; 모바일UI/UX(제안) |
| 온디바이스 AI | 트랙전공 | 모델 경량화·양자화, TFLite/Core ML, 엣지 추론 | 단말 내 실시간 AI 기능 탑재 | 온디바이스AI·모바일머신러닝(신설 제안); Gemini Nano·Apple Foundation Models(산업 트렌드) |
| 생성형 AI 모바일 서비스 | 트랙전공 | LLM API·sLM, RAG, 멀티모달 연동 | 대화형 AI 모바일 앱 구현 | 생성형AI앱개발·모바일AI서비스(신설 제안) |
| 모바일 캡스톤 | 트랙전공 | 기획·개발·배포·운영, 산학 협업 | AI 모바일 서비스 종합 완성 | 캡스톤디자인(제안) |
