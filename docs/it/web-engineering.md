...
```mermaid
flowchart LR
  M1["① AI·데이터 공통 기초<br/>논리적 사고와 프로그래밍 · 프로그래밍랩 · AI를 이용한 주식가치평가"] --> CAP
  M2["② 컴퓨터과학 기반<br/>자료구조 · 컴퓨터구조 · 운영체제 · 데이터통신"] --> CAP
  M3["③ 소프트웨어공학 기반<br/>객체지향언어1 · 객체지향언어2 · 소프트웨어공학 · 설계패턴"] --> CAP
  M4["④ 프론트엔드 개발<br/>웹프로그래밍기초 · 웹프로그래밍 · 컴퓨터그래픽스"] --> CAP
  M5["⑤ 백엔드·데이터베이스<br/>웹서버프로그래밍 · 데이터베이스 · 웹프레임워크1 · 웹프레임워크2"] --> CAP
  M6["⑥ 클라우드·DevOps<br/>클라우드 컴퓨팅 · 네트워크프로그래밍 · 시스템프로그래밍"] --> CAP
  M7["⑦ RAG·LLM 웹 서비스<br/>데이터마이닝 · 컴퓨터비젼 · 생성형AI웹서비스 · RAG시스템"] --> CAP
  CAP["웹공학 캡스톤디자인 · 융합캡스톤디자인 · 기업연계 SW캡스톤디자인"]
```
