...
> 출처: 한성대학교 웹공학트랙 공식 교과과정([https://www.hansung.ac.kr/Engineering/4910/subview.do](https://www.hansung.ac.kr/Engineering/4910/subview.do)) 기준, 확인일 2026-06-30. 구성 교과목 공식, 미존재 보강은 (예시). (전기=전공기초·전필=전공필수·전선=전공선택)

| 모듈 | 모듈명 | 구성 교과목 (학년-학기·이수구분) | 모듈 설명 | 모듈 학습성과 | 모듈 간 관계 |
| --- | --- | --- | --- | --- | --- |
| **M1** | AI·데이터 공통 기초 | 논리적 사고와 프로그래밍(1-1·전선) · 프로그래밍랩(1-2·전선) · AI를 이용한 주식가치평가(1-1·전선) · AI·데이터 리터러시(예시) | Python·데이터 처리, 생성형 AI/LLM 활용, AI 코딩 어시스턴트, AI 윤리 | AI 도구로 데이터 처리·프로토타이핑 수행 | 단과대학공통 |
| **M2** | 컴퓨터과학 기반 | 자료구조(1-2·전선) · 컴퓨터구조(1-2·전선) · 운영체제(3-1·전선) · 데이터통신(2-2·전선) | 자료구조, 알고리즘, 운영체제, 네트워크 | 시스템 동작 원리 이해 및 효율적 알고리즘 설계 | 학부공통 |
| **M3** | 소프트웨어공학 기반 | 객체지향언어1(1-2·전선) · 객체지향언어2(2-2·전선) · 소프트웨어공학(3-1·전선) · 설계패턴(3-2·전선) | 객체지향, 협업·형상관리, 테스트 | 협업 기반 SW 개발 프로세스 수행 | 학부공통 |
| **M4** | 프론트엔드 개발 | 웹프로그래밍기초(1-2·전기) · 웹프로그래밍(3-1·전필) · 컴퓨터그래픽스(3-1·전선) · 프론트엔드개발(예시) | HTML/CSS/JS, React 등 SPA, 웹 UI/UX | 인터랙티브 웹 프론트엔드 구현 | 트랙전공 |
| **M5** | 백엔드·데이터베이스 | 웹서버프로그래밍(3-2·전필) · 데이터베이스(3-1·전선) · 웹프레임워크1(4-1·전필) · 웹프레임워크2(4-2·전필) | REST/GraphQL API, 서버 프레임워크, RDB/NoSQL | 확장 가능한 웹 백엔드·DB 구현 | 트랙전공 |
| **M6** | 클라우드·DevOps | 클라우드 컴퓨팅(4-2·전필) · 네트워크프로그래밍(3-2·전선) · 시스템프로그래밍(3-2·전선) · 데브옵스(예시) | 컨테이너, CI/CD, 클라우드·서버리스, 모니터링 | 무중단 배포·운영 파이프라인 구축 | 트랙전공 |
| **M7** | RAG·LLM 웹 서비스 | 데이터마이닝(3-1·전선) · 컴퓨터비젼(3-2·전선) · 생성형AI웹서비스(예시) · RAG시스템(예시) | 벡터DB, RAG, LLM API 연동, 챗봇·검색 | 지능형 AI 웹 기능 구현 | 트랙전공 |
| **M8** | 웹 캡스톤 | 웹공학 캡스톤디자인(4-2·전필) · 융합캡스톤디자인(4-2·전선) · 기업연계 SW캡스톤디자인(3-2·전선) | 기획·개발·배포·운영, 산학 협업 | AI 웹 서비스 종합 완성 | 트랙전공 |
