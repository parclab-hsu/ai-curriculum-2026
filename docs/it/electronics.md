...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Engineering/4917/subview.do](https://www.hansung.ac.kr/Engineering/4917/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.
...
| 회로·신호 기반 | 학부공통 | 회로이론, 전자기학, 신호및시스템 | 전기전자 핵심 물리·수학 모델 해석·적용 | 회로이론 Ⅰ · 회로이론 Ⅱ · 전자기학 · 신호 및 시스템 |
| 디지털·임베디드 기반 | 학부공통 | 디지털논리, 마이크로프로세서, 임베디드 C | 임베디드 타깃에 펌웨어 설계·구현 | 논리회로 · 디지털회로 실험 · 마이크로프로세서실험 · 임베디드시스템 |
| 아날로그·신호처리 심화 | 트랙전공 | 신호처리, 영상처리, 제어 | 센서 신호 취득·필터링·특징추출 구현 | 디지털 신호처리 · 디지털영상처리 · 전기전자회로실험 · 제어공학 |
| 통신·네트워크 | 트랙전공 | 통신이론, 데이터통신, 무선통신 | 통신 시스템 신호·프로토콜 설계·분석 | 통신공학 Ⅰ · 통신공학 Ⅱ · 데이터통신 및 컴퓨터네트워크 · 무선통신공학 |
| 엣지 AI·지능형 전자시스템 설계 | 트랙전공 | 엣지 AI·TinyML, 센서-신호-AI 통합 | 엣지 추론 파이프라인 통합 시스템 구현 | 인공지능 · 전자종합설계프로젝트 · 엣지AI·TinyML(예시) · 임베디드AI설계(예시) |
...
flowchart LR
  ...
  subgraph Y2["2학년 · 전공기반"]
    M2["② 회로·신호 기반<br/>회로이론 · 전자기학 · 신호 및 시스템"]
    M3["③ 디지털·임베디드 기반<br/>논리회로 · 마이크로프로세서실험 · 임베디드시스템"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M4["④ 아날로그·신호처리 심화<br/>디지털 신호처리 · 디지털영상처리 · 제어공학"]
    M5["⑤ 통신·네트워크<br/>통신공학 · 데이터통신 · 무선통신공학"]
    M6["⑥ 엣지 AI·지능형 전자시스템 설계<br/>인공지능 · 임베디드시스템 · 엣지AI"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["캡스톤<br/>전자종합설계프로젝트"]
  end
  A0 --> M1
  A0 --> M2
  A0 --> M3
...
| --- | --- | --- |
| ① AI·데이터 공통 기초 | Python·자료구조, 인공지능, AI 윤리 | Python, Git, TensorFlow Lite·PyTorch(엣지), AI 신뢰성 |
| ② 회로·신호 기반 | 회로이론, 전자기학, 신호및시스템 | 회로설계, 신호처리, MATLAB/Simulink |
| ③ 디지털·임베디드 기반 | 디지털논리, 마이크로프로세서, 임베디드 C | C/C++, MCU·펌웨어, RTOS, 디바이스 드라이버, Linux |
| ④ 아날로그·신호처리 심화 | 신호처리, 영상처리, 제어 | 신호처리, 제어이론, 비전·센서 융합(sensor fusion) |
| ⑤ 통신·네트워크 | 통신이론, 데이터통신, 무선통신 | 신호처리, 비전·센서 융합(sensor fusion) |
| ⑥ 엣지 AI·지능형 전자시스템 설계 | 엣지 AI·TinyML, 센서-신호-AI 통합 | 엣지 AI·온디바이스 추론, TinyML, 모델 경량화/양자화, NPU·AI 가속기 연동 |
| 캡스톤(전자종합설계프로젝트) | 센서-신호-AI 통합 시스템 설계 | Physical AI(체화 AI) 제어, 엣지 AI 추론, 임베디드기사·전자기사 |
