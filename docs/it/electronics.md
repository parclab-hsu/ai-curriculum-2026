...
flowchart LR
  ...
  M2["② 회로·신호 기반<br/>회로이론 · 전자기학 · 신호 및 시스템"] --> CAP
  M3["③ 디지털·임베디드 기반<br/>논리회로 · 마이크로프로세서실험 · 임베디드시스템"] --> CAP
  M4["④ 아날로그·신호처리 심화<br/>디지털 신호처리 · 디지털영상처리 · 제어공학"] --> CAP
  M5["⑤ 통신·네트워크<br/>통신공학 · 데이터통신 · 무선통신공학"] --> CAP
  M6["⑥ 엣지 AI·지능형 전자시스템 설계<br/>인공지능 · 임베디드시스템 · 엣지AI"] --> CAP
  CAP["전자종합설계프로젝트 · 캡스톤"]
```
