...
> 출처: 한성대학교 디지털콘텐츠·가상현실트랙 공식 교과과정([https://www.hansung.ac.kr/Engineering/4903/subview.do](https://www.hansung.ac.kr/Engineering/4903/subview.do)) 기준, 확인일 2026-06-30. 구성 교과목 공식, 미존재 보강은 (예시). (전기=전공기초·전필=전공필수·전선=전공선택)

| 모듈 | 모듈명 | 구성 교과목 (학년-학기·이수구분) | 모듈 설명 | 모듈 학습성과 | 모듈 간 관계 |
| --- | --- | --- | --- | --- | --- |
| **M1** | AI·데이터 공통 기초 | 프로그래밍랩(1-2·전선) · 객체지향언어1(2-1·전선) · 웹프로그래밍기초(1-2·전기) · 확률및통계(2-1·전선) | Python·데이터 처리, 생성형 AI/LLM 활용, AI 코딩 어시스턴트, AI 윤리 | AI 도구로 데이터 처리·프로토타이핑 수행 | 단과대학공통 |
| **M2** | 컴퓨터과학 기반 | 자료구조(2-1·전선) · 컴퓨터구조(2-1·전선) · 알고리즘(2-2·전선) · 운영체제(3-1·전선) | 자료구조, 알고리즘, 운영체제, 네트워크 | 시스템 동작 원리 이해 및 효율적 알고리즘 설계 | 학부공통 |
| **M3** | 그래픽스 수학·기반 | 선형대수(2-2·전선) · 컴퓨터그래픽스(3-1·전선) · 게임그래픽&애니메이션(2-2·전필) · 소프트웨어공학(3-1·전선) | 선형대수, 기하, 컴퓨터그래픽스 원리 | 3D 변환·렌더링 원리 이해 및 구현 | 학부공통 |
| **M4** | XR·게임엔진 개발 | XR 프로그래밍(3-1·전필) · 가상현실(3-2·전필) · 안드로이드프로그래밍(3-1·전선) · 오픈소스소프트웨어(2-2·전선) | Unity/Unreal, AR/VR, 인터랙션 디자인 | 인터랙티브 XR 콘텐츠 독립 구현 | 트랙전공 |
| **M5** | 컴퓨터비전·인식 | 영상처리(3-1·전필) · 컴퓨터비젼(3-2·전선) · 딥러닝비전(예시) · SLAM(예시) | 객체인식, 자세추정, SLAM, 딥러닝 비전 | 실시간 비전 인식 시스템 구현 | 트랙전공 |
| **M6** | Physical AI·생성형 콘텐츠 | 지능형 증강현실 시스템(4-2·전필) · 디지털콘텐츠기획및제작(4-1·전필) · 피지컬AI(예시) · 생성형AI콘텐츠(예시) | 텍스트-3D, 디지털 휴먼, 센서·시뮬레이션 | 생성형 AI 기반 콘텐츠·지능 제어 파이프라인 구축 | 트랙전공 |
| **M7** | 실감미디어 캡스톤 | 디지털콘텐츠·가상현실 캡스톤디자인(4-2·전필) · 가상현실 애니메이션 캡스톤디자인(1-1·전선) · 융합캡스톤디자인(4-2·전선) | 기획·제작·시연, 산학 협업 | 몰입형 XR·AI 콘텐츠 종합 완성 | 트랙전공 |
