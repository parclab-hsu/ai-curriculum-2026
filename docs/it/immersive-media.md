...
지능형실감미디어공학트랙은 XR(AR/VR/MR)·메타버스·버추얼 프로덕션·디지털휴먼·실시간 3D 그래픽스를 다루는 트랙입니다.

**AI 융합 개편 방향**: 생성형 3D(Diffusion·Gaussian Splatting/NeRF)와 AI NPC·디지털휴먼을 결합하고, **2026 Physical AI**(시뮬레이션·합성데이터·디지털트윈)로 가장 밀접하게 수렴하는 트랙으로서, 실감미디어 기술스택이 곧 Physical AI의 가상세계 구축 기반과 동일 계열임을 교육에 반영합니다.
...
!!! tip "추가 보강 제안 (2026 개편 반영안 · 공식 교과 아님)"
    ...
    - **추가 기술트렌드:** Gaussian Splatting · 디지털휴먼 · 합성데이터 · 시뮬레이션
    - **추가 직무역량:** Unity/Unreal · 컴퓨터비전 · 실시간 렌더링
    - **교육과정 보강(제안):** XR-Physical AI 시뮬레이션 모듈 강화
...
> 학문 분야 정체성: 지능형실감미디어공학트랙은 3D 그래픽스·XR(AR/VR)·컴퓨터비전 SW공학 역량에 Physical AI와 생성형 AI를 결합하여, 현실과 가상을 잇는 몰입형 지능 미디어 시스템을 설계·구현하는 엔지니어를 양성합니다.
...
> 출처: 한성대학교 디지털콘텐츠·가상현실트랙 공식 교과과정([https://www.hansung.ac.kr/Engineering/4903/subview.do](https://www.hansung.ac.kr/Engineering/4903/subview.do)) 기준, 확인일 2026-06-30. 구성 교과목 공식, 미존재 보강은 (제안). (전기=전공기초·전필=전공필수·전선=전공선택)
...
| --- | --- | --- | --- | --- | --- | --- |
| **M1** | AI·데이터 공통 기초 | 프로그래밍랩(1-2·전선) · 객체지향언어1(2-1·전선) · 웹프로그래밍기초(1-2·전기) · 확률및통계(2-1·전선) | Python·데이터 처리, 생성형 AI/LLM 활용, AI 코딩 어시스턴트, AI 윤리 | AI 도구로 데이터 처리·프로토타이핑 수행 | 단과대학공통 | 공식 |
| **M2** | 컴퓨터과학 기반 | 자료구조(2-1·전선) · 컴퓨터구조(2-1·전선) · 알고리즘(2-2·전선) · 운영체제(3-1·전선) | 자료구조, 알고리즘, 운영체제, 네트워크 | 시스템 동작 원리 이해 및 효율적 알고리즘 설계 | 학부공통 | 공식 |
| **M3** | 그래픽스 수학·기반 | 선형대수(2-2·전선) · 컴퓨터그래픽스(3-1·전선) · 게임그래픽&애니메이션(2-2·전필) · 소프트웨어공학(3-1·전선) | 선형대수, 기하, 컴퓨터그래픽스 원리 | 3D 변환·렌더링 원리 이해 및 구현 | 학부공통 | 공식 |
| **M4** | XR·게임엔진 개발 | XR 프로그래밍(3-1·전필) · 가상현실(3-2·전필) · 안드로이드프로그래밍(3-1·전선) · 오픈소스소프트웨어(2-2·전선) | Unity/Unreal, AR/VR, 인터랙션 디자인 | 인터랙티브 XR 콘텐츠 독립 구현 | 트랙전공 | 공식 |
| **M5** | 컴퓨터비전·인식 | 영상처리(3-1·전필) · 컴퓨터비젼(3-2·전선) · 딥러닝비전(제안) · SLAM(제안) | 객체인식, 자세추정, SLAM, 딥러닝 비전 | 실시간 비전 인식 시스템 구현 | 트랙전공 | 공식·제안 |
| **M6** | Physical AI·생성형 콘텐츠 | 지능형 증강현실 시스템(4-2·전필) · 디지털콘텐츠기획및제작(4-1·전필) · 피지컬AI(제안) · 생성형AI콘텐츠(제안) | 텍스트-3D, 디지털 휴먼, 센서·시뮬레이션 | 생성형 AI 기반 콘텐츠·지능 제어 파이프라인 구축 | 트랙전공 | 공식·제안 |
| **M7** | 실감미디어 캡스톤 | 디지털콘텐츠·가상현실 캡스톤디자인(4-2·전필) · 가상현실 애니메이션 캡스톤디자인(1-1·전선) · 융합캡스톤디자인(4-2·전선) | 기획·제작·시연, 산학 협업 | 몰입형 XR·AI 콘텐츠 종합 완성 | 트랙전공 | 공식 |

### 10-2. 모듈형 교육과정 로드맵 (학년·학기)

| 모듈 | 1-1 | 1-2 | 2-1 | 2-2 | 3-1 | 3-2 | 4-1 | 4-2 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| **M1** AI·데이터 공통 기초 | | 프로그래밍랩 · 웹프로그래밍기초 | 객체지향언어1 · 확률및통계 | | | | | |
| **M2** 컴퓨터과학 기반 | | | 자료구조 · 컴퓨터구조 | 알고리즘 | 운영체제 | | | |
| **M3** 그래픽스 수학·기반 | | | | 선형대수 · 게임그래픽&애니메이션 | 컴퓨터그래픽스 · 소프트웨어공학 | | | |
| **M4** XR·게임엔진 개발 | | | | 오픈소스소프트웨어 | XR 프로그래밍 · 안드로이드프로그래밍 | 가상현실 | | |
| **M5** 컴퓨터비전·인식 | | | | | 영상처리 | 컴퓨터비젼 | | |
| **M6** Physical AI·생성형 콘텐츠 | | | | | | | 디지털콘텐츠기획및제작 | 지능형 증강현실 시스템 |
| **M7** 실감미디어 캡스톤 | 가상현실 애니메이션 캡스톤디자인 | | | | | | | 디지털콘텐츠·가상현실 캡스톤디자인 · 융합캡스톤디자인 |
...
flowchart LR
  ...
  M2 --> M5["M5 컴퓨터비전·인식"]
  M3 --> M4["M4 XR·게임엔진 개발"]
  M3 --> M6["M6 Physical AI·생성형 콘텐츠"]
  M4 --> CAP["M7 실감미디어 캡스톤"]
  M5 --> CAP
  M6 --> CAP
```

- **마이크로디그리:** "XR·Physical AI" 마이크로디그리(M5 컴퓨터비전·인식 + M6 Physical AI·생성형 콘텐츠 + M4 XR·게임엔진 개발) 운영.
...
| 진로 분야 | 권장 모듈 조합 | 지향 |
| --- | --- | --- |
| XR·메타버스 개발 | M4 XR·게임엔진 개발 + M3 그래픽스 수학·기반 + M1 AI·데이터 공통 기초 | XR/메타버스 개발자·게임 클라이언트 개발자 |
| 컴퓨터비전·Physical AI | M5 컴퓨터비전·인식 + M6 Physical AI·생성형 콘텐츠 + M2 컴퓨터과학 기반 | 비전 AI 엔지니어·로보틱스 SW 엔지니어 |
| 생성형 AI 콘텐츠 제작 | M6 Physical AI·생성형 콘텐츠 + M4 XR·게임엔진 개발 + M7 실감미디어 캡스톤 | 생성형 AI 테크니컬 아티스트·콘텐츠 개발자 |
...
!!! info "진출 직무 — 이런 전문가로 성장할 수 있어요"
    ...
    - **컴퓨터비전·Physical AI 엔지니어 (경로 A):** 카메라·센서가 본 세상을 컴퓨터가 이해하게 만들고, 그 인식으로 로봇과 기기를 실제로 움직이는 엔지니어입니다. 화면 속 코드가 현실의 로봇을 움직이는 순간, AI가 세상과 맞닿는 최전선에 서 있다는 짜릿함을 느낄 수 있습니다. → *AI 활용 능력·역량:* 객체 인식·자세 추정·SLAM 모델을 실시간 인식·제어에 연결하는 **컴퓨터비전·Physical AI 역량**.
    - **XR·생성형 콘텐츠 개발자 (경로 B):** AR/VR 몰입형 콘텐츠를 게임엔진으로 빚어내고, 3D 에셋과 디지털휴먼을 더해 체험형 세계를 완성하는 개발자입니다. 내가 만든 가상 공간에 사람들이 직접 들어와 감탄하는, 상상을 현실 경험으로 바꾸는 창작의 즐거움을 누릴 수 있습니다. → *AI 활용 능력·역량:* 텍스트-3D·이미지 생성으로 에셋을 만들고 AI NPC·디지털휴먼을 콘텐츠에 담는 **생성형 XR 콘텐츠 제작 역량**.
    - **버추얼 프로덕션 테크니컬 디렉터 (경로 C):** LED월·실시간 렌더링으로 촬영·방송 현장을 가상 배경과 합쳐 만들고, 제작 파이프라인 전체를 기술로 총괄하는 리더입니다. 영화 같은 장면이 눈앞에서 실시간으로 완성되는 현장을 진두지휘하는 존재감을 경험할 수 있습니다. → *AI 활용 능력·역량:* 생성형 3D·디지털휴먼 도구로 배경·캐릭터 제작을 자동화하고 품질을 끌어올리는 **버추얼 프로덕션 기술 총괄 역량**.
    - **디지털트윈·로보틱스 시뮬레이션 엔지니어 (경로 D):** 공장·로봇을 가상 공간에 똑같이 복제해 미리 시험하고, AI 학습용 데이터를 시뮬레이션으로 만들어 내는 엔지니어입니다. 현실을 통째로 가상에 옮겨 미래를 미리 돌려 보는, 시뮬레이션으로 세상을 설계하는 힘을 손에 넣을 수 있습니다. → *AI 활용 능력·역량:* Isaac Sim 등으로 합성데이터를 생성하고 Sim-to-Real로 로봇 학습을 돕는 **디지털트윈·시뮬레이션 역량**.

### 10-5. 상위 수준 보완 권고

> 아래는 KAIST 문화기술대학원·한국예술종합학교·중앙대 첨단영상대학원 등 XR·디지털콘텐츠 특성화 **상위 비교군** 및 산업 표준 정렬을 위한 **보완 권고**입니다. **공식 교과를 대체하지 않으며**, 2027학년도 교과 개편 시 심의 의견·향후 개선 계획으로 활용합니다.

| 보완 영역 | 반영 위치 | 추가하면 좋은 내용 | 기대 효과 |
| --- | --- | --- | --- |
| 3DGS/NeRF 기반 3D 재구성 | M3, M6 | Gaussian Splatting·NeRF 실시간 장면 재구성, 포토그래메트리 캡처-정제 파이프라인, MPEG 3DGS 압축 | 실사 기반 에셋 자동 생성으로 비교군 수준 실감 콘텐츠 제작 역량 확보 |
| 디지털휴먼·MetaHuman 제작 | M4, M6 | MetaHuman 페이셜 리깅, 음성·표정 합성, 립싱크·뉴럴 렌더링 디지털휴먼 파이프라인 | 버추얼휴먼 산업(자이언트스텝·비브) 직무 즉시 투입 수준 도달 |
| 합성데이터·시뮬레이션 | M5, M6 | Isaac Sim·Omniverse 디지털트윈, 도메인 랜덤화 합성데이터 생성, Sim-to-Real | Physical AI 학습용 데이터 자급으로 비전·로보틱스 연계 경쟁력 강화 |
| OpenXR·실시간 렌더링 최적화 | M4, M3 | OpenXR 크로스플랫폼 이식, Nanite/Lumen·포비티드 렌더링, 프로파일링 기반 GPU 최적화 | 갤럭시 XR·Vision Pro 다기기 대응 및 고프레임 안정성 확보 |
| 모션캡처·볼류메트릭 캡처 | M4, M7 | 마커리스 모션캡처, 볼류메트릭 비디오, 리타게팅·실시간 퍼포먼스 캡처 | 버추얼 프로덕션·디지털휴먼 캡처 워크플로 산학 캡스톤 직결 |
| 공간 인식·SLAM 고도화 | M5, M2 | 비주얼-관성 SLAM, 신경망 깊이 추정, 공간 앵커·메시 재구성 기반 AR 오클루전 | 공간컴퓨팅(AR 글래스) 핵심 인식 모듈 자립 구현 역량 확보 |
