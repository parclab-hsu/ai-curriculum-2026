...
| --- | --- | --- | --- | --- |
| AI·데이터 공통 기초 | 단과대학공통 | Python·데이터 처리, 생성형 AI/LLM 활용, AI 코딩 어시스턴트, AI 윤리 | AI 도구로 데이터 처리·프로토타이핑 수행 | 프로그래밍랩, 객체지향언어1, AI·데이터 리터러시(제안) |
| 컴퓨터과학 기반 | 학부공통 | 자료구조, 알고리즘, 운영체제, 네트워크 | 시스템 동작 원리 이해 및 효율적 알고리즘 설계 | 자료구조, 컴퓨터구조, 데이터통신, 운영체제(제안) |
| 그래픽스 수학·기반 | 학부공통 | 선형대수, 기하, 컴퓨터그래픽스 원리 | 3D 변환·렌더링 원리 이해 및 구현 | 선형대수, 컴퓨터그래픽스(제안) |
| XR·게임엔진 개발 | 트랙전공 | Unity/Unreal, AR/VR, 인터랙션 디자인 | 인터랙티브 XR 콘텐츠 독립 구현 | 가상현실 애니메이션 캡스톤디자인, 게임엔진프로그래밍(제안), XR콘텐츠개발(제안) |
| 컴퓨터비전·인식 | 트랙전공 | 객체인식, 자세추정, SLAM, 딥러닝 비전 | 실시간 비전 인식 시스템 구현 | 컴퓨터비전(제안), 영상처리(제안) |
| Physical AI·로보틱스 | 트랙전공 | 센서융합, 로봇제어, 시뮬레이션, 강화학습 | 현실 연동 지능 제어 시스템 구현 | 피지컬AI(제안), 로보틱스시뮬레이션(제안) |
| 생성형 AI 콘텐츠 | 트랙전공 | 텍스트-3D, 이미지·영상 생성, 디지털 휴먼 | 생성형 AI 기반 콘텐츠 파이프라인 구축 | 생성형AI콘텐츠(제안), 디지털휴먼(제안) |
| 실감미디어 캡스톤 | 트랙전공 | 기획·제작·시연, 산학 협업 | 몰입형 XR·AI 콘텐츠 종합 완성 | 가상현실 애니메이션 캡스톤디자인 |
