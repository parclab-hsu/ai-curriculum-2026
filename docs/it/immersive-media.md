...
```mermaid
flowchart LR
  M1["① AI·데이터 공통 기초<br/>프로그래밍랩 · 객체지향언어1 · 확률및통계"] --> CAP
  M2["② 컴퓨터과학 기반<br/>자료구조 · 컴퓨터구조 · 알고리즘"] --> CAP
  M3["③ 그래픽스 수학·기반<br/>선형대수 · 컴퓨터그래픽스 · 소프트웨어공학"] --> CAP
  M4["④ XR·게임엔진 개발<br/>XR 프로그래밍 · 가상현실 · 안드로이드프로그래밍"] --> CAP
  M5["⑤ 컴퓨터비전·인식<br/>영상처리 · 컴퓨터비젼"] --> CAP
  M6["⑥ Physical AI·생성형 콘텐츠<br/>지능형 증강현실 시스템 · 디지털콘텐츠기획및제작"] --> CAP
  CAP["종합설계 · 디지털콘텐츠·가상현실 캡스톤디자인"]
```
