...
**AI 융합 개편 방향.** 전통적 산업공학(IE) 방법론(최적화·확률통계·시뮬레이션)에 **AI/데이터 역량을 결합**하여, 스마트팩토리·디지털 트윈·AI 에이전트 환경에서 "현장 문제를 정의하고 AI로 푸는" 융합형 엔지니어를 양성한다.
...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Engineering/4994/subview.do](https://www.hansung.ac.kr/Engineering/4994/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.

| 모듈명 | 계층 | 핵심 역량·주제 | 학습 성과 | 대표 교과(공식/제안) |
| --- | --- | --- | --- | --- |
| AI·데이터 공통 기초 | 단과대학 공통 | Python·데이터베이스, 인공지능 활용, 생성형 AI, AI 윤리 | 데이터를 다루고 ML 모델과 생성형 AI 도구를 책임 있게 활용 | 공학프로그래밍 · 데이터베이스 설계 및 활용 · 인공지능의 이해와 활용 · 생성형 AI 활용(예시) |
| 산업통계·OR 기초 | 학부 공통 | 확률·통계, 선형/정수계획, 경영과학 | 산업 문제를 수리모형으로 정식화하고 해석 | 산업공학개론 · 공학확률과 통계 · 경영과학Ⅰ · 경영과학Ⅱ |
| 시스템 모델링·시뮬레이션 | 학부 공통 | 이산사건 시뮬레이션, 통계응용, 공학경제 | 복잡 시스템을 모델링·시뮬레이션으로 분석 | 시스템 시뮬레이션 · 공학통계응용 · 공학경제개론 · 기술경영 |
| 생산·품질·안전 시스템 | 트랙 전공 | 생산계획, 품질공학(SPC), 인간공학, 안전 | 생산·품질 시스템을 설계·관리 | 생산경영 · 품질 및 공정관리 · 인간공학 · 안전관리 |
| SCM·물류·ERP | 트랙 전공 | 공급망·물류, ERP 프로세스, 고객관리 | 물류·구매·생산 프로세스를 ERP로 통합 운영 | 물류경영 · SAP 구매 프로세스 · SAP 생산 프로세스 · CRM |
| 제조AI·디지털트윈 | 트랙 전공 | 공정 데이터 분석, 디지털트윈, 예측정비(PdM) | 스마트팩토리 지능형 운영 모델 설계 | 프로세스혁신 · 제조 공정 및 자동화 · 디자인과 제조 · 디지털트윈(예시) |
| 산업AI 캡스톤 | 트랙 전공 | 융합 종합설계, 산학 프로젝트 | 실데이터로 최적화·AI 통합 솔루션 도출 | 산업시스템공학 캡스톤디자인 · 제조데이터분석(예시) · 산업AI 종합설계(예시) |
...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["기초 입문<br/>공학수학 · 공학프로그래밍"]
    M1["① AI·데이터 공통 기초<br/>데이터베이스 설계 및 활용 · 인공지능의 이해와 활용 · 생성형 AI 활용"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M2["② 산업통계·OR 기초<br/>산업공학개론 · 공학확률과 통계 · 경영과학"]
    M3["③ 시스템 모델링·시뮬레이션<br/>시스템 시뮬레이션 · 공학통계응용 · 공학경제개론"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M4["④ 생산·품질·안전 시스템<br/>생산경영 · 품질 및 공정관리 · 인간공학"]
    M5["⑤ SCM·물류·ERP<br/>물류경영 · SAP 구매 프로세스 · SAP 생산 프로세스"]
    M6["⑥ 제조AI·디지털트윈<br/>프로세스혁신 · 제조 공정 및 자동화 · 디자인과 제조"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["⑦ 산업AI 캡스톤<br/>산업시스템공학 캡스톤디자인"]
  end
  A0 --> M1
  A0 --> M2
  M1 --> M6
...
아래 표는 각 모듈의 핵심 학습 역량을 4장의 기업 요구 직무 역량과 직접 연결한 것이다.

| 모듈 | 핵심 역량(학습) | 매핑되는 기업 요구 역량 |
| --- | --- | --- |
| ① AI·데이터 공통 기초 | Python·데이터베이스, 인공지능 활용, AI 윤리 | Python, SQL, 제조 데이터 분석, AI 에이전트 활용·연계 |
| ② 산업통계·OR 기초 | 확률·통계, 선형/정수계획, 경영과학 | 통계적 의사결정, 수리·메타휴리스틱 최적화(LP/MIP, 휴리스틱) |
| ③ 시스템 모델링·시뮬레이션 | 이산사건 시뮬레이션, 통계응용, 공학경제 | 시스템 시뮬레이션, 디지털 트윈/시뮬레이션 모델링(AnyLogic, Plant Simulation) |
| ④ 생산·품질·안전 시스템 | 생산계획, 품질공학(SPC), 인간공학, 안전 | 생산·공정관리, 품질관리(SPC), 산업안전 |
| ⑤ SCM·물류·ERP | 공급망·물류, ERP 프로세스, 고객관리 | SCM·재고·물류 최적화, ERP/MES |
| ⑥ 제조AI·디지털트윈 | 공정 데이터 분석, 디지털트윈, 예측정비(PdM) | 제조 데이터 분석, AI 수요예측, 예측 정비(ML 기반), 디지털 트윈 모델링 |
| 캡스톤(산업AI 캡스톤) | 융합 종합설계, 산학 프로젝트 | 최적화·AI 통합 솔루션 도출, 빅데이터분석기사·ADsP·SQLD, 품질경영기사 |
