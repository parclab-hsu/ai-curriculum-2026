...
```mermaid
flowchart LR
  M1["① AI·데이터 공통 기초<br/>공학프로그래밍 · 데이터베이스 설계 및 활용 · 인공지능의 이해와 활용"] --> CAP
  M2["② 산업통계·OR 기초<br/>산업공학개론 · 공학확률과 통계 · 경영과학"] --> CAP
  M3["③ 시스템 모델링·시뮬레이션<br/>시스템 시뮬레이션 · 공학통계응용 · 공학경제개론"] --> CAP
  M4["④ 생산·품질·안전 시스템<br/>생산경영 · 품질 및 공정관리 · 인간공학"] --> CAP
  M5["⑤ SCM·물류·ERP<br/>물류경영 · SAP 구매 프로세스 · SAP 생산 프로세스"] --> CAP
  M6["⑥ 제조AI·디지털트윈<br/>프로세스혁신 · 제조 공정 및 자동화 · 디자인과 제조"] --> CAP
  CAP["산업시스템공학 캡스톤디자인 · 종합설계"]
```
