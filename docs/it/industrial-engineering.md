...
| --- | --- | --- | --- | --- |
| AI·데이터 공통 기초 | 단과대학 공통 | Python·데이터, 생성형 AI 활용, ML 기초, AI 윤리 | 데이터를 다루고 ML 모델과 생성형 AI 도구를 책임 있게 활용 | 공학프로그래밍, 데이터 분석 기초(제안), 생성형 AI 활용(제안), AI 윤리(제안) |
| 산업통계·OR 기초 | 학부 공통 | 확률·통계, 선형/정수계획, 의사결정론 | 산업 문제를 수리모형으로 정식화하고 해석 | 산업공학개론, 공학통계와 통계, 경영과학, 최적화이론(제안) |
| 시스템 모델링·시뮬레이션 | 학부 공통 | 이산사건 시뮬레이션, 시스템 다이내믹스 | 복잡 시스템을 모델링·시뮬레이션으로 분석 | 시스템 시뮬레이션, 시스템모델링(제안) |
| 생산·품질 시스템 | 트랙 전공 | 생산계획, 공정설계, 품질공학(SPC) | 생산·품질 시스템을 설계·관리 | 생산경영, 품질 및 공정관리, 제조 공정 및 자동화 |
| AI 수요예측·SCM | 트랙 전공 | 시계열·ML 수요예측, 재고·물류 최적화 | AI 기반 SCM 의사결정 모델 구현 | SAP 구매 프로세스, 공급망관리(제안), AI 수요예측(제안), 물류최적화(제안) |
| 제조AI·디지털트윈 | 트랙 전공 | 공정 데이터 분석, 디지털트윈, 예측정비(PdM) | 스마트팩토리 지능형 운영 모델 설계 | 프로세스혁신, 스마트제조(제안), 디지털트윈(제안), 제조데이터분석(제안) |
| 산업AI 캡스톤 | 트랙 전공 | 융합 종합설계, 산학 프로젝트 | 실데이터로 최적화·AI 통합 솔루션 도출 | 산업공학종합설계(캡스톤)(제안) |
