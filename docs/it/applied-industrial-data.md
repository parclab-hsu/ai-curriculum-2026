...
```mermaid
flowchart LR
  M1["① AI·데이터 공통 기초<br/>데이터리터러시 · 공학프로그래밍 · 인공지능의 이해와 활용"] --> CAP
  M2["② 산업통계·최적화<br/>데이터공학 선형대수 · 공학확률과 통계 · 경영과학Ⅰ"] --> CAP
  M3["③ 데이터 엔지니어링·시각화<br/>데이터베이스 설계 및 활용 · 데이터 시각화와 비즈니스 인텔리전스 · 기업데이터프로그래밍"] --> CAP
  M4["④ 산업 빅데이터·AI 응용<br/>생산 빅데이터 · 인공지능 응용 · 비즈니스 애널리틱스 응용"] --> CAP
  M5["⑤ 산업 도메인·운영데이터<br/>CRM · 디지털트윈 · MLOps"] --> CAP
  CAP["종합설계 · 캡스톤<br/>산업시스템공학 캡스톤디자인 · 기업데이터캡스톤디자인"]
```
