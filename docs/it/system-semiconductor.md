...
```mermaid
flowchart LR
  M1["① AI·데이터 공통 기초<br/>프로그래밍언어 · 자료구조 · 인공지능"] --> CAP
  M2["② 회로·신호 기반<br/>회로이론 · 전자기학 · 전기전자회로실험"] --> CAP
  M3["③ 디지털·임베디드 기반<br/>디지털회로 실험 · 마이크로프로세서실험 · 임베디드시스템"] --> CAP
  M4["④ 반도체 소자·공정 심화<br/>반도체소자 · 전자회로 · 반도체공정"] --> CAP
  M5["⑤ 디지털설계·집적회로<br/>디지털집적회로 · 아날로그집적회로 · 시스템반도체설계및실습"] --> CAP
  M6["⑥ AI 가속기·AI EDA<br/>인공지능 · AI반도체설계 · AI 기반 EDA"] --> CAP
  CAP["시스템반도체캡스톤디자인 · SoC캡스톤디자인"]
```
