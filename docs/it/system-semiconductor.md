...
!!! abstract "이 트랙과 향후 10년 고용"
    ...
    - **중국:** 미·중 반도체 전략 경쟁과 휴머노이드·산업로봇용 추론 칩 수요(휴머노이드 2025년 약 12,800대, 세계 90%) 확대가 시스템반도체 설계 인력 경쟁을 심화시킨다.
...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Engineering/4924/subview.do](https://www.hansung.ac.kr/Engineering/4924/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.

| 모듈명 | 계층 | 핵심 역량·주제 | 학습 성과 | 대표 교과(공식/제안) |
| --- | --- | --- | --- | --- |
| AI·데이터 공통 기초 | 단과대학공통 | Python·자료구조, 인공지능, 생성형 AI 활용, AI 윤리 | 데이터 처리·AI 도구 활용 및 윤리적 판단 가능 | 프로그래밍언어 · 자료구조 · 인공지능 · 생성형 AI 활용(예시) |
| 회로·신호 기반 | 학부공통 | 회로이론, 전자기학, 회로실험 | 전기전자 핵심 물리·수학 모델 해석·적용 | 회로이론 Ⅰ · 회로이론 Ⅱ · 전자기학 · 전기전자회로실험 |
| 디지털·임베디드 기반 | 학부공통 | 디지털논리, 마이크로프로세서, 임베디드, 신호처리 | 디지털 시스템·펌웨어 설계·구현 | 디지털회로 실험 · 마이크로프로세서실험 · 임베디드시스템 · 디지털 신호처리 |
| 반도체 소자·공정 심화 | 트랙전공 | 반도체소자, 아날로그/CMOS 회로, 공정, 센서 | 소자 동작 해석 및 CMOS 회로 설계 | 반도체소자 · 전자회로 · 반도체공정 · 반도체센서 |
| 디지털설계·집적회로 | 트랙전공 | 집적회로 설계, RTL·SoC, 시스템반도체 설계 | RTL 설계·합성·검증 수행 | 디지털집적회로 · 아날로그집적회로 · 시스템반도체설계및실습 · 제어공학 |
| AI 가속기·AI EDA | 트랙전공 | NPU 아키텍처, 신경망 HW 매핑, AI 기반 EDA | AI 가속 IP 설계 및 PPA 평가·설계 자동화 | 인공지능 · AI반도체설계(예시) · AI 기반 EDA(예시) |
...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["기초 입문<br/>공학수학 · 프로그래밍언어"]
    M1["① AI·데이터 공통 기초<br/>자료구조 · 인공지능 · 생성형 AI 활용"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M2["② 회로·신호 기반<br/>회로이론 · 전자기학 · 전기전자회로실험"]
    M3["③ 디지털·임베디드 기반<br/>디지털회로 실험 · 마이크로프로세서실험 · 임베디드시스템"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M4["④ 반도체 소자·공정 심화<br/>반도체소자 · 전자회로 · 반도체공정"]
    M5["⑤ 디지털설계·집적회로<br/>디지털집적회로 · 아날로그집적회로 · 시스템반도체설계및실습"]
    M6["⑥ AI 가속기·AI EDA<br/>인공지능 · AI반도체설계 · AI 기반 EDA"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["캡스톤<br/>시스템반도체캡스톤디자인"]
  end
  A0 --> M1
  A0 --> M2
  A0 --> M3
...
| --- | --- | --- |
| ① AI·데이터 공통 기초 | Python·자료구조, 인공지능, AI 윤리 | Python/Tcl, 머신러닝 워크로드·데이터플로우 이해, AI 기반 설계자동화 |
| ② 회로·신호 기반 | 회로이론, 전자기학, 회로실험 | 아날로그 회로설계, 신호무결성, MATLAB |
| ③ 디지털·임베디드 기반 | 디지털논리, 마이크로프로세서, 신호처리 | 논리설계, RTL 설계, 디지털 검증 |
| ④ 반도체 소자·공정 심화 | 반도체소자, CMOS 회로, 공정, 센서 | 반도체 소자/공정, 디지털/아날로그 회로설계 |
| ⑤ 디지털설계·집적회로 | 집적회로 설계, RTL·SoC, 시스템반도체 | RTL 설계(Verilog/SystemVerilog), 물리설계(PnR), SystemVerilog·UVM, Cadence·Synopsys EDA |
| ⑥ AI 가속기·AI EDA | NPU 아키텍처, 신경망 HW 매핑, AI 기반 EDA | NPU·AI 가속기 아키텍처, 엣지 AI·온디바이스 추론 칩 설계, AI 기반 EDA·설계자동화 |
| 캡스톤(시스템반도체캡스톤디자인) | SoC 종합 설계·검증 | 디지털 검증(설계 30%:검증 70%), AMBA(AXI/APB), 반도체설계기사·전자기사 |

### 10-2. 모듈 간 관계 (트랙·학부·단과대학)

- **위계**: 단과대학 공통(AI·데이터 기초) → 기계전자공학부(현행)/전기전자공학부(개편명) 공통(회로·전자기·신호 / 디지털·임베디드) → 시스템반도체트랙 전공심화(반도체 소자·회로 → 디지털설계·SoC → AI 가속기·AI EDA).
- **선후수**: 「디지털논리회로」 이수 후 「디지털시스템설계(HDL)」 수강 / 「디지털시스템설계(HDL)」·「컴퓨터구조」 이수 후 「AI반도체설계」 수강.
- **마이크로디그리**: 'AI 가속기·AI EDA' 모듈을 3과목 묶음 마이크로디그리로 인증하여 인접트랙·컴퓨터계열 학생에게 개방.
- **교차수강**: 전자트랙의 「엣지AI·TinyML」, 컴퓨터계열의 「머신러닝」을 교차수강하여 AI 모델·소프트웨어 관점을 보강.

### 10-3. 진로 분야별 모듈 조합 가이드

| 진로 분야 | 권장 모듈 조합 | 목표 직무 |
| --- | --- | --- |
| AI 반도체·NPU 설계 | 디지털설계·SoC + AI 가속기·AI EDA + 디지털·임베디드 기반 | AI 반도체(NPU) 설계 엔지니어 |
| SoC·디지털 IC 설계 | 디지털·임베디드 기반 + 디지털설계·SoC + 반도체 소자·회로 심화 | SoC/디지털 설계 엔지니어 |
| 반도체 설계 자동화(EDA) | AI·데이터 공통 기초 + 디지털설계·SoC + AI 가속기·AI EDA | EDA/설계검증 엔지니어 |
