...
| 회로·신호 기반 | 학부공통 | 회로이론, 전자기학, 신호및시스템 | 전기전자 핵심 물리·수학 모델 해석·적용 | 회로이론 I, 회로이론 II, 전자기학, 신호 및 시스템(제안) |
| 디지털·임베디드 기반 | 학부공통 | 디지털논리, 마이크로프로세서, 임베디드 C | 디지털 시스템·펌웨어 설계·구현 | 디지털회로 실험, 마이크로프로세서(제안) |
| 반도체 소자·회로 심화 | 트랙전공 | 반도체소자, 아날로그/CMOS 회로, 공정 | 소자 동작 해석 및 CMOS 회로 설계 | 반도체소자, 전자회로, 반도체공정 |
| 디지털설계·SoC | 트랙전공 | HDL(Verilog), RTL 설계, 컴퓨터구조, SoC | RTL 설계·합성·검증 수행 | 디지털집적회로, 시스템반도체설계및실습, 디지털시스템설계(HDL)(제안) |
| AI 가속기·AI EDA | 트랙전공 | NPU 아키텍처, 신경망 HW 매핑, AI 기반 EDA | AI 가속 IP 설계 및 PPA 평가·설계 자동화 | AI반도체설계(신설 제안), 반도체캡스톤(제안) |
