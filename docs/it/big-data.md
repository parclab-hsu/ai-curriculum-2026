...
```mermaid
flowchart LR
  M1["① AI·데이터 공통 기초<br/>컴퓨터프로그래밍 · 프로그래밍랩 · AI를 이용한 주식가치평가"] --> CAP
  M2["② 컴퓨터과학·수학 기반<br/>자료구조 · 알고리즘 · 확률및통계 · 선형대수"] --> CAP
  M3["③ 시스템·SW공학 기반<br/>컴퓨터구조 · 운영체제 · 소프트웨어공학"] --> CAP
  M4["④ 데이터 엔지니어링<br/>데이터베이스 · 빅데이터기초 · 빅데이터프로그래밍"] --> CAP
  M5["⑤ 머신러닝·딥러닝<br/>데이터마이닝 · 컴퓨터비젼 · 영상처리"] --> CAP
  M6["⑥ RAG·LLM 데이터 활용<br/>인공지능 · 오픈소스소프트웨어 · 생성형AI데이터분석"] --> CAP
  CAP["종합설계 · 빅데이터 캡스톤디자인"]
```
