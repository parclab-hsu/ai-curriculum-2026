...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Engineering/4896/subview.do](https://www.hansung.ac.kr/Engineering/4896/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.

| 모듈명 | 계층 | 핵심 역량·주제 | 학습 성과 | 대표 교과(공식 3~4과목) |
| --- | --- | --- | --- | --- |
| ① AI·데이터 공통 기초 | 단과대학공통 | Python·데이터 처리, 생성형 AI/LLM 활용, AI 코딩 어시스턴트, AI 윤리 | AI 도구로 데이터 처리·프로토타이핑 수행 | 컴퓨터프로그래밍 · 프로그래밍랩 · 객체지향언어1 · AI를 이용한 주식가치평가 |
| ② 컴퓨터과학·수학 기반 | 학부공통 | 자료구조, 알고리즘, 확률·통계, 선형대수 | 효율적 알고리즘 설계 및 데이터 모델링 기반 확립 | 자료구조 · 알고리즘 · 확률및통계 · 선형대수 |
| ③ 시스템·SW공학 기반 | 학부공통 | 운영체제, 컴퓨터구조, 협업·설계, 테스트 | 협업 기반 SW 개발 프로세스 수행 | 컴퓨터구조 · 운영체제 · 소프트웨어공학 · 설계패턴 |
| ④ 데이터 엔지니어링 | 트랙전공 | 데이터베이스, 분산처리(Spark), ETL, 데이터레이크 | 대용량 데이터 파이프라인 구현 | 데이터베이스 · 데이터베이스설계 · 빅데이터기초 · 빅데이터프로그래밍 |
| ⑤ 머신러닝·딥러닝 | 트랙전공 | 지도/비지도학습, 딥러닝, 비전, 모델 평가 | 데이터 기반 예측·분류 모델 구현 | 데이터마이닝 · 컴퓨터비젼 · 영상처리 · 딥러닝(예시) |
| ⑥ RAG·LLM 데이터 활용 | 트랙전공 | 벡터DB, RAG, LLM 분석·질의, MLOps | 비정형 데이터 LLM 활용 시스템 구현 | 인공지능 · 오픈소스소프트웨어 · 생성형AI데이터분석(예시) · RAG시스템(예시) |
| ⑦ 빅데이터 캡스톤 | 트랙전공 | 데이터·AI 파이프라인 구축·운영, 산학 협업 | 데이터 AI 시스템 종합 완성 | 빅데이터 캡스톤디자인 · 기업연계 SW캡스톤디자인 · 융합캡스톤디자인 |
...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["기초 입문<br/>컴퓨터프로그래밍 · 프로그래밍랩"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M1["① AI·데이터 공통 기초<br/>객체지향언어1 · AI를 이용한 주식가치평가"]
    M2["② 컴퓨터과학·수학 기반<br/>자료구조 · 알고리즘 · 확률및통계"]
    M3["③ 시스템·SW공학 기반<br/>컴퓨터구조 · 운영체제 · 소프트웨어공학"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M4["④ 데이터 엔지니어링<br/>데이터베이스 · 빅데이터기초 · 빅데이터프로그래밍"]
    M5["⑤ 머신러닝·딥러닝<br/>데이터마이닝 · 컴퓨터비젼 · 영상처리"]
    M6["⑥ RAG·LLM 데이터 활용<br/>인공지능 · 오픈소스소프트웨어 · 생성형AI데이터분석"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["⑦ 빅데이터 캡스톤<br/>빅데이터 캡스톤디자인 · 융합캡스톤디자인"]
  end
  A0 --> M1
  A0 --> M2
  A0 --> M3
...
| --- | --- | --- |
| ① AI·데이터 공통 기초 | Python·데이터 처리, 생성형 AI/LLM 활용, AI 코딩 어시스턴트 | 핵심 직무 역량(Python), AI 융합 역량(Prompt Engineering 등 LLM 활용 리터러시) |
| ② 컴퓨터과학·수학 기반 | 자료구조, 알고리즘, 확률·통계, 선형대수 | 핵심 직무 역량(자료구조·알고리즘), ML/MLOps(ML 알고리즘 구현 기반) |
| ③ 시스템·SW공학 기반 | 운영체제, 컴퓨터구조, 협업·설계, 테스트 | 클라우드/인프라(Kubernetes 운영 기반), ML/MLOps(분산 컴퓨팅 기반) |
| ④ 데이터 엔지니어링 | 데이터베이스, 분산처리(Spark), ETL, 데이터레이크 | 데이터 엔지니어링(Spark·Airflow·dbt·Kafka·Flink, Lakehouse·DW, 배치+실시간) |
| ⑤ 머신러닝·딥러닝 | 지도/비지도학습, 딥러닝, 비전, 모델 평가 | ML/MLOps(ML 알고리즘 구현, 모델 서빙·배포) |
| ⑥ RAG·LLM 데이터 활용 | 벡터DB, RAG, LLM 분석·질의, MLOps | AI 융합 역량(LLM 파인튜닝, RAG 파이프라인, 벡터DB, LangGraph, Agentic AI, 멀티모달) |
| ⑦ 빅데이터 캡스톤 | 데이터·AI 파이프라인 구축·운영, 산학 협업 | ML/MLOps(모델 서빙·배포, 분산 컴퓨팅), 클라우드/인프라(AWS·GCP·Azure, Kubernetes) |
