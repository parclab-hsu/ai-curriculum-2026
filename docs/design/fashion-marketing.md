...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Design/5105/subview.do](https://www.hansung.ac.kr/Design/5105/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.

| 모듈명 | 계층 | 핵심 역량·주제 | 학습 성과 | 대표 교과(공식 3~4과목) |
| --- | --- | --- | --- | --- |
| AI 디자인 리터러시 | 단과대학공통 | 생성형 AI 비주얼 도구, 프롬프트 디자인, AI 저작권·윤리, 데이터 기반 디자인 기초 | 디자인 맥락에서 AI 도구를 책임 있게 활용하고 윤리·저작권을 판단한다 | AI시대 패션리더십 · AI패션콘텐츠 크리에이션 캡스톤디자인 · AI디자인리터러시(예시) |
| 패션산업·소비자 이해 | 학부공통 | 패션산업 구조, 소비자행동, 트렌드 분석 | 산업 가치사슬과 소비자 의사결정을 설명하고 트렌드를 해석한다 | 패션비지니스 이해 · 의복사회심리 · 소비자행동 · 글로벌패션시스템 |
| 패션 데이터 분석 기초 | 학부공통 | 마케팅·시장 데이터 수집·시각화·통계 | 패션 데이터를 정제·시각화하고 인사이트를 도출한다 | 패션시장조사 · 패션데이터 어낼리틱스 · 패션 포토 |
| 패션 마케팅·브랜딩 | 트랙전공 | STP, 브랜드 관리, IMC, 포지셔닝 | 시장을 세분화하고 통합 브랜드 커뮤니케이션 전략을 수립한다 | 패션마케팅 · 패션브랜드와커뮤니케이션 · 패션상품기획 캡스톤디자인 |
| 머천다이징·리테일 | 트랙전공 | 상품기획, 가격·재고관리, 옴니채널 리테일 | 머천다이징 계획과 채널 전략을 수립·운영한다 | 패션유통관리 · 패션리테일링 · 패션소재기획 · 의류소재의이해 |
| AI 수요예측·개인화 추천 | 트랙전공 | 수요예측 모델, 추천 알고리즘, 고객 세분화 | AI로 수요를 예측하고 개인화 추천·세분화를 마케팅에 적용한다 | 패션데이터 어낼리틱스 · 온라인 패션스타트업 캡스톤디자인 · AI수요예측(예시) · 추천시스템과CRM(예시) |
| 생성형 AI 콘텐츠 마케팅 | 트랙전공 | AI 카피·비주얼 생성, 콘텐츠 운영, 성과 측정 | 생성형 AI로 캠페인 콘텐츠를 제작하고 성과를 검증한다 | AI패션콘텐츠 크리에이션 캡스톤디자인 · AI시대 패션리더십 · 생성형AI콘텐츠마케팅(예시) |
...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["① AI 디자인 리터러시<br/>AI시대 패션리더십 · AI디자인리터러시"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M2["② 패션산업·소비자 이해<br/>패션비지니스 이해 · 소비자행동"]
    M3["③ 패션 데이터 분석 기초<br/>패션시장조사 · 패션데이터 어낼리틱스"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M4["④ 패션 마케팅·브랜딩<br/>패션마케팅 · 패션브랜드와커뮤니케이션"]
    M5["⑤ 머천다이징·리테일<br/>패션유통관리 · 패션리테일링"]
    M6["⑥ AI 수요예측·개인화 추천<br/>패션데이터 어낼리틱스 · 추천시스템과CRM"]
    M7["⑦ 생성형 AI 콘텐츠 마케팅<br/>AI패션콘텐츠 크리에이션 · 생성형AI콘텐츠마케팅"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["캡스톤<br/>패션창업 캡스톤디자인 · 종합설계"]
  end
  A0 --> M2
  A0 --> M3
  M2 --> M4
...
| --- | --- | --- |
| ① AI 디자인 리터러시 | 생성형 AI 비주얼 도구·프롬프트·AI 저작권/윤리 | 생성형 AI 카피·소재 제작 활용 (퍼포먼스 광고) |
| ② 패션산업·소비자 이해 | 패션산업 구조·소비자행동·트렌드 분석 | 브랜드 전략·마케팅 기획 |
| ③ 패션 데이터 분석 기초 | 마케팅·시장 데이터 수집·시각화·통계 | 데이터 기반 의사결정 (대시보드·예측모델 활용) |
| ④ 패션 마케팅·브랜딩 | STP·브랜드 관리·IMC·포지셔닝 | 브랜드 전략·마케팅 기획 |
| ⑤ 머천다이징·리테일 | 상품기획·가격/재고관리·옴니채널 리테일 | 머천다이징·재고 기획 (AI 수요예측 운영 적용) |
| ⑥ AI 수요예측·개인화 추천 | 수요예측 모델·추천 알고리즘·고객 세분화 | 고객 세분화·CRM 운영, AI 수요예측·판매데이터 해석 |
| ⑦ 생성형 AI 콘텐츠 마케팅 | AI 카피·비주얼 생성·콘텐츠 운영·성과 측정 | 퍼포먼스 광고 운영·성과분석, 생성형 AI 소재 제작 |
| 캡스톤 | 산학 데이터 기반 통합 마케팅 솔루션 개발 | 데이터 기반 의사결정 · 브랜드 전략·마케팅 기획 (통합) |
