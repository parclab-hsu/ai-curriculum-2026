...
## 1. 개요
패션마케팅트랙은 브랜드 전략, 소비자 행동 분석, 디지털·퍼포먼스 마케팅, CRM, 머천다이징을 다루는 트랙입니다. 'AI패션학부' 개편 방향은 마케터의 직관 중심 의사결정을 **데이터·AI 기반 의사결정**으로 전환하는 것으로, 수요예측·개인화 추천·고객 세분화·AI 콘텐츠 운영 역량을 마케팅 교육의 핵심 축으로 결합합니다.
...
## 8. 교육 목표 (예시)
> 학문 분야 정체성: 패션마케팅트랙은 소비자·시장·브랜드에 대한 통찰을 바탕으로 패션 상품의 기획부터 유통·판매·커뮤니케이션까지 가치를 설계하고 전달하는 전문가를 양성하는 트랙입니다.
...
!!! info "진출 직무 — 이런 전문가로 성장할 수 있어요"
    ...
    - **AI 기반 패션 MD/바이어 (경로 A):** '무엇이 팔릴지'를 데이터로 먼저 읽어 시즌 상품 구성과 발주 물량·가격을 정하는 상품기획의 주역입니다. 내가 고른 상품이 매장과 앱을 채우고 매출로 증명되는 성취를 직접 경험할 수 있습니다. → *AI 활용 능력·역량:* 판매·재고·트렌드 데이터로 수요를 예측하고 추천 모델로 잘 팔릴 상품과 발주량을 최적화하는 **데이터 기반 상품기획 역량**.
    - **디지털 콘텐츠 마케터 (경로 B):** 브랜드의 SNS·광고·영상 콘텐츠를 기획·제작해 사람들의 시선을 사로잡는 마케터입니다. 내가 만든 캠페인이 수많은 사람에게 퍼지고 반응이 숫자로 돌아오는 재미를 느낄 수 있습니다. → *AI 활용 능력·역량:* 생성형 AI로 카피·이미지·영상 시안을 빠르게 만들고 반응 데이터로 콘텐츠를 개선하는 **AI 콘텐츠 기획·제작 역량**.
    - **AI 그로스·CRM 마케터 (경로 C):** 확보한 고객이 떠나지 않고 다시 찾게 만들어 매출 성장(그로스)을 이끄는 마케터입니다. 데이터로 고객을 이해하고 성과를 끌어올리는 손맛을 볼 수 있습니다. → *AI 활용 능력·역량:* 고객 데이터로 이탈을 예측하고 개인화 추천·A/B 테스트로 전환율을 높이는 **데이터 기반 그로스 역량**.
    - **패션 커머스 창업가/브랜드 매니저 (경로 D):** 자체 브랜드(D2C)를 만들어 상품 기획부터 판매·운영까지 총괄하는 창업가·브랜드 책임자입니다. 나만의 브랜드를 세상에 내놓고 키워가는 도전을 해볼 수 있습니다. → *AI 활용 능력·역량:* 수요예측·콘텐츠 생성·CRM을 AI 도구로 소규모 팀처럼 운영하는 **1인 브랜드 운영 역량**.

### 10-5. 상위 수준 보완 권고

> 아래는 한양대·중앙대 의류학, 성균관대 마케팅 등 패션마케팅·리테일테크 특성화 **상위 비교군** 및 산업 표준 정렬을 위한 **보완 권고**입니다. **공식 교과를 대체하지 않으며**, 2027학년도 교과 개편 시 심의 의견·향후 개선 계획으로 활용합니다.
