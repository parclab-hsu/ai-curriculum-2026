...
```mermaid
flowchart LR
  M1["① AI 디자인 리터러시<br/>AI시대 패션리더십 · AI패션콘텐츠 크리에이션"] --> CAP
  M2["② 패션산업·소비자 이해<br/>패션비지니스 이해 · 의복사회심리 · 소비자행동"] --> CAP
  M3["③ 패션 데이터 분석 기초<br/>패션시장조사 · 패션데이터 어낼리틱스 · 패션 포토"] --> CAP
  M4["④ 패션 마케팅·브랜딩<br/>패션마케팅 · 패션브랜드와커뮤니케이션 · 패션상품기획"] --> CAP
  M5["⑤ 머천다이징·리테일<br/>패션유통관리 · 패션리테일링 · 패션소재기획"] --> CAP
  M6["⑥ AI 수요예측·개인화 추천<br/>패션데이터 어낼리틱스 · 온라인 패션스타트업"] --> CAP
  M7["⑦ 생성형 AI 콘텐츠 마케팅<br/>AI패션콘텐츠 크리에이션 · AI시대 패션리더십"] --> CAP
  CAP["패션창업 캡스톤디자인 · 종합설계"]
```
