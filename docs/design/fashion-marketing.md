...
| 패션산업·소비자 이해 | 학부공통 | 패션산업 구조, 소비자행동, 트렌드 분석 | 산업 가치사슬과 소비자 의사결정을 설명하고 트렌드를 해석한다 | 패션비지니스 이해, 의복사회심리 |
| 패션 데이터 분석 기초 | 학부공통 | 마케팅·디자인 데이터 수집·시각화·통계 | 패션 데이터를 정제·시각화하고 인사이트를 도출한다 | 패션데이터 어널리틱스, 패션시장조사 |
| 패션 마케팅·브랜딩 | 트랙전공 | STP, 브랜드 관리, IMC, 포지셔닝 | 시장을 세분화하고 통합 브랜드 커뮤니케이션 전략을 수립한다 | 패션마케팅, 패션브랜드와커뮤니케이션 |
| 머천다이징·리테일 | 트랙전공 | 상품기획, 가격·재고관리, 옴니채널 리테일 | 머천다이징 계획과 채널 전략을 수립·운영한다 | 패션소재기획, 의류소재의이해 |
| AI 수요예측·개인화 추천 | 트랙전공 | 수요예측 모델, 추천 알고리즘, 고객 세분화 | AI로 수요를 예측하고 개인화 추천·세분화를 마케팅에 적용한다 | 패션데이터 어널리틱스, AI수요예측(제안), 추천시스템과CRM(제안) |
| 생성형 AI 콘텐츠 마케팅 | 트랙전공 | AI 카피·비주얼 생성, 콘텐츠 운영, 성과 측정 | 생성형 AI로 캠페인 콘텐츠를 제작하고 성과를 검증한다 | AI패션콘텐츠 크리에이션 캡스톤디자인, 생성형AI콘텐츠마케팅(제안) |
