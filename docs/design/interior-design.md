...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Design/5159/subview.do](https://www.hansung.ac.kr/Design/5159/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.
>
> ※ 교과목 로드맵 상세 페이지가 PDF·이미지로만 제공되어 일부 **WebFetch 실패—기존 데이터(학부 필수 교과목 및 공식 디자인학부 공통 교과) 기준**으로 매핑함.

| 모듈명 | 계층 | 핵심 역량·주제 | 학습 성과 | 대표 교과(공식·예시) |
| --- | --- | --- | --- | --- |
| AI 디자인 리터러시 | 단과대학공통 | 생성형 AI 비주얼 도구, 프롬프트 디자인, 데이터 기반 디자인, AI 저작권·윤리 | AI 도구로 디자인 대안을 생성·평가하고 윤리·저작권을 준수한다 | AI 공간디자인기초 · AI 기반 공간렌더링 · 생성형 AI 디자인 입문(예시) · AI 저작권·윤리(예시) |
| 디자인 기초·시각조형 | 학부공통 | 조형 원리, 색채·타이포, 디자인 사고 | 디자인 기본 문법으로 시각 결과물을 구성한다 | 공간 조형 · 디자인컨셉 · 기초조형(예시) · 색채와 디자인(예시) |
| 디지털 디자인 도구 | 학부공통 | 2D/3D 디지털 저작, 디자인 데이터 처리 | 디지털 도구로 디자인 산출물을 제작·관리한다 | 드로잉과 CAD · IOT인터페이스디자인 · UX·UI디자인 기초 · 3D 모델링 기초(예시) |
| 공간 기획·설계 | 트랙전공 | 평면계획, 인간공학, 동선·프로그래밍 | 사용자 요구를 공간 설계안으로 변환한다 | 기초공간디자인 · 실내디자인 스튜디오 · 디자인과 감성공학 · 한국전통디자인 |
| 재료·조명·환경 | 트랙전공 | 재료·마감, 조명·색온도, 친환경 설계 | 재료·조명·환경 요소를 설계에 통합한다 | 홈인테리어디자인 · 레스토랑디자인 · 가구디자인 · 브랜드숍디자인 |
| AI 공간 비주얼라이제이션 | 트랙전공 | AI 렌더링, 컨셉 이미지 생성, 프롬프트-투-스페이스(prompt-to-space) | AI 워크플로우로 공간 컨셉·렌더링을 신속히 제작한다 | AI 기반 공간렌더링 · AI 공간디자인기초 · 디자인상품화스튜디오 · 생성형 컨셉 스튜디오(예시) |
| 공간 데이터·캡스톤 | 트랙전공 | 동선·점유 데이터 분석, 종합 설계 | 데이터 근거 기반 종합 공간설계를 완수한다 | 실내디자인종합설계 · 실내디자인과 창업 · 취업과 포트폴리오 · 인테리어 취업 캡스톤디자인 |
...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["기초 입문<br/>공간 조형 · 디자인컨셉"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M1["① AI 디자인 리터러시<br/>AI 공간디자인기초 · AI 기반 공간렌더링"]
    M2["② 디자인 기초·시각조형<br/>기초조형 · 색채와 디자인"]
    M3["③ 디지털 디자인 도구<br/>드로잉과 CAD · UX·UI디자인 기초"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M4["④ 공간 기획·설계<br/>기초공간디자인 · 실내디자인 스튜디오"]
    M5["⑤ 재료·조명·환경<br/>홈인테리어디자인 · 레스토랑디자인 · 가구디자인"]
    M6["⑥ AI 공간 비주얼라이제이션<br/>AI 기반 공간렌더링 · 디자인상품화스튜디오"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["⑦ 공간 데이터·캡스톤<br/>실내디자인종합설계 · 인테리어 취업 캡스톤디자인"]
  end
  A0 --> M1
  A0 --> M2
  A0 --> M3
...
| --- | --- | --- |
| ① AI 디자인 리터러시 | 생성형 AI 비주얼 도구, 프롬프트 디자인, AI 저작권·윤리 | 생성형 AI 렌더링(미드저니·Stable Diffusion·DALL·E) + 프롬프트 엔지니어링 |
| ② 디자인 기초·시각조형 | 조형 원리, 색채·타이포, 디자인 사고 | 수작업 스케치 / 컬러리스트기사·산업기사 |
| ③ 디지털 디자인 도구 | 2D/3D 디지털 저작, 디자인 데이터 처리 | 2D/3D CG / AutoCAD·SketchUp, 3ds Max·V-Ray·Enscape·Lumion·Blender |
| ④ 공간 기획·설계 | 평면계획, 인간공학, 동선·프로그래밍 | 공간기획, 평면·입면·상세·투시도 설계 |
| ⑤ 재료·조명·환경 | 재료·마감, 조명·색온도, 친환경 설계 | 재료·마감 선정, 시공관리 |
| ⑥ AI 공간 비주얼라이제이션 | AI 렌더링, 컨셉 이미지 생성, 프롬프트-투-스페이스 | AI 리스타일링(RoomGPT·Interior AI), AI 상담·자동 컨셉 도출 |
| ⑦ 공간 데이터·캡스톤 | 동선·점유 데이터 분석, 종합 설계 | BIM·디지털 트윈 데이터 설계 / Revit(BIM) |
