...
```mermaid
flowchart LR
  M1["① AI 디자인 리터러시<br/>AI 공간디자인기초 · AI 기반 공간렌더링"] --> CAP
  M2["② 디자인 기초·시각조형<br/>공간 조형 · 디자인컨셉"] --> CAP
  M3["③ 디지털 디자인 도구<br/>드로잉과 CAD · IOT인터페이스디자인 · UX·UI디자인 기초"] --> CAP
  M4["④ 공간 기획·설계<br/>기초공간디자인 · 실내디자인 스튜디오 · 디자인과 감성공학"] --> CAP
  M5["⑤ 재료·조명·환경<br/>홈인테리어디자인 · 레스토랑디자인 · 가구디자인"] --> CAP
  M6["⑥ AI 공간 비주얼라이제이션<br/>AI 기반 공간렌더링 · 디자인상품화스튜디오"] --> CAP
  M7["⑦ 공간 데이터·캡스톤<br/>실내디자인과 창업 · 취업과 포트폴리오"] --> CAP
  CAP["실내디자인종합설계<br/>종합 설계 · 캡스톤"]
```
