...
VMD전시디자인트랙은 **비주얼 머천다이징(VMD)** — 매장 디스플레이·진열 전략·집기 디자인 — 과 **전시디자인**(박물관·과학관·테마파크·미디어아트·팝업)을 다룹니다. 전통적 '진열·연출'에서 **리테일테크·생성형 AI 비주얼·데이터 기반 매장 분석·몰입형 실감미디어**로 융합 확장 중입니다.

**AI 융합 개편 방향**: VMD를 '공간 그래픽 + 생성형 AI 비주얼 + 매장 데이터 분석'의 융합 직무로, 전시디자인을 '몰입형·실감미디어 + 디지털 트윈' 직무로 재정의합니다.
...
> 학문 분야 정체성: VMD전시디자인트랙은 브랜드·상품·콘텐츠의 메시지를 공간 연출과 디스플레이로 시각화하여 관람·구매 경험을 설계하는 비주얼 머천다이징·전시 디자인 전문가를 양성합니다.
...
!!! info "진출 직무 — 이런 전문가로 성장할 수 있어요"
    ...
    - **VMD 디자이너·비주얼 머천다이저 (경로 A):** 브랜드 매장을 하나의 무대로 연출해, 손님의 발길과 시선을 붙잡고 '사고 싶다'는 마음을 디자인하는 매장 연출의 주역입니다. 내가 세운 진열과 디스플레이가 실제 매장을 채우고 매출로 이어지는 성취를 눈앞에서 확인할 수 있습니다. → *AI 활용 능력·역량:* 미드저니·Firefly로 브랜드 톤에 맞는 매장 무드보드와 진열 시안을 신속히 발산·정제하는 **생성형 AI 기반 VMD 연출 역량**.
    - **전시 디자이너·공간 연출 기획자 (경로 B):** 박물관·박람회·팝업의 콘셉트와 동선, 볼거리를 처음부터 끝까지 설계해 관람객을 이야기 속으로 빠져들게 만드는 공간 연출가입니다. 텅 빈 공간이 내 손끝에서 감동을 주는 경험 무대로 완성되는 성취를 직접 누릴 수 있습니다. → *AI 활용 능력·역량:* 관람 동선·체류 데이터를 AI로 분석해 연출 효과를 정량적으로 검증·개선하는 **데이터 기반 전시 연출 역량**.
    - **실감미디어 전시 디자이너 (경로 C):** 프로젝션 매핑·미디어아트로 벽과 공간 전체를 움직이는 화면으로 바꿔, 관람객을 압도하는 몰입형 실감 전시를 만드는 크리에이터입니다. 디스트릭트·닷밀 같은 화제의 전시를 내 손으로 구현하는 짜릿한 성취를 경험할 수 있습니다. → *AI 활용 능력·역량:* 생성형 AI와 디지털 트윈으로 인터랙티브 실감 영상 콘텐츠를 제작하는 **몰입형 실감미디어 제작 역량**.
    - **연출 비주얼라이저·컨셉 아트 디렉터 (경로 D):** 브랜드 연출과 전시 전체의 비주얼 톤을 잡고 콘셉트의 방향을 결정하는, 팀의 미감을 이끄는 아트 디렉터입니다. 내가 정한 무드가 프로젝트 전체의 얼굴이 되는 창작의 주도권을 손에 쥘 수 있습니다. → *AI 활용 능력·역량:* 프롬프트 디자인으로 브랜드 톤을 일관되게 유지하며 연출 시안을 대량 생성·큐레이션하는 **AI 비주얼 디렉팅 역량**.

### 10-5. 상위 수준 보완 권고

> 아래는 홍익대·국민대·건국대 공간·전시디자인 등 VMD·전시·리테일테크 특성화 **상위 비교군** 및 산업 표준 정렬을 위한 **보완 권고**입니다. **공식 교과를 대체하지 않으며**, 2027학년도 교과 개편 시 심의 의견·향후 개선 계획으로 활용합니다.
