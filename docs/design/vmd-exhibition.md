...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Design/5154/subview.do](https://www.hansung.ac.kr/Design/5154/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.
...
| 디자인 기초·시각조형 | 학부공통 | 조형 원리, 색채·타이포, 디자인 사고 | 디자인 기본 문법으로 시각 결과물을 구성한다 | 공간 조형 · 디자인컨셉 · 컬러와 패턴디자인 · 한국전통디자인 |
| 디지털 디자인 도구 | 학부공통 | 2D/3D 디지털 저작, 그래픽·이미지 처리 | 디지털 도구로 연출용 비주얼을 제작·관리한다 | 드로잉과 CAD · IOT인터페이스디자인 · UX·UI디자인 기초 · 디자인과 감성공학 |
| VMD·연출 기획 | 트랙전공 | 머천다이징, 공간 연출, 브랜드 스토리텔링 | 브랜드 메시지를 공간 연출 전략으로 구성한다 | VMD와 전시무대디자인 · VMD스튜디오 · 브랜드디자인 · 디자인컨설팅 |
| 디스플레이·그래픽·조명 | 트랙전공 | 디스플레이 구조, 사이니지·그래픽, 조명 연출 | 디스플레이·그래픽·조명을 통합 연출한다 | 가구디자인 · 브랜드숍디자인 · 디스플레이 취업 · 패키지디자인-캡스톤디자인 |
| AI 연출 비주얼라이제이션 | 트랙전공 | AI 무드보드, 연출 시안 생성, 프롬프트-투-씬(prompt-to-scene) | AI 워크플로우로 연출 무드·시안을 신속히 제작한다 | AI 공간디자인기초 · AI 기반 공간렌더링 · 디자인상품화스튜디오 · 생성형 연출 무드보드(예시) |
| 관람 데이터·캡스톤 | 트랙전공 | 동선·체류·시선 데이터 분석, 종합 연출 | 데이터 근거 기반 종합 VMD/전시 연출을 완수한다 | 전시디자인 스튜디오1 · 전시디자인 스튜디오2 · VMD창업과 실무 캡스톤디자인 · 레이아웃디자인-캡스톤디자인 |
...
flowchart LR
  ...
  subgraph Y2["2학년 · 전공기반"]
    ...
    M2["② 디자인 기초·시각조형<br/>컬러와 패턴디자인 · 한국전통디자인"]
    M3["③ 디지털 디자인 도구<br/>드로잉과 CAD · UX·UI디자인 기초"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M4["④ VMD·연출 기획<br/>VMD와 전시무대디자인 · VMD스튜디오"]
    M5["⑤ 디스플레이·그래픽·조명<br/>브랜드숍디자인 · 패키지디자인"]
    M6["⑥ AI 연출 비주얼라이제이션<br/>AI 기반 공간렌더링 · 디자인상품화스튜디오"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["⑦ 관람 데이터·캡스톤<br/>전시디자인 스튜디오 · VMD창업과 실무 캡스톤디자인"]
  end
  A0 --> M1
  A0 --> M2
  A0 --> M3
...
| --- | --- | --- |
| ① AI 디자인 리터러시 | 생성형 AI 비주얼 도구, 프롬프트 디자인, AI 저작권·윤리 | 생성형 AI 비주얼(미드저니·Adobe Firefly·Stable Diffusion) |
| ② 디자인 기초·시각조형 | 조형 원리, 색채·타이포, 디자인 사고 | VMD/공간/그래픽 기획·디자인 / 컬러리스트 산업기사·기사 |
| ③ 디지털 디자인 도구 | 2D/3D 디지털 저작, 그래픽·이미지 처리 | Photoshop·Illustrator(상급), SketchUp·3ds Max |
| ④ VMD·연출 기획 | 머천다이징, 공간 연출, 브랜드 스토리텔링 | VMD/공간/그래픽 기획·디자인, 전시 콘셉트·동선 기획 |
| ⑤ 디스플레이·그래픽·조명 | 디스플레이 구조, 사이니지·그래픽, 조명 연출 | 스토어 포맷별 디스플레이 전략, 집기 디자인, 진열 가이드 수립, 디지털 사이니지 기획 |
| ⑥ AI 연출 비주얼라이제이션 | AI 무드보드, 연출 시안 생성, 프롬프트-투-씬 | AI 렌더링·디지털 트윈·실감콘텐츠 제작, 인터랙티브 미디어 기획 |
| ⑦ 관람 데이터·캡스톤 | 동선·체류·시선 데이터 분석, 종합 연출 | 매장 데이터(동선·구매) 분석 리터러시, 전시 콘셉트·동선 기획 |
