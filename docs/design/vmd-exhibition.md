...
flowchart LR
  ...
  M2["② 디자인 기초·시각조형<br/>공간 조형 · 디자인컨셉 · 컬러와 패턴디자인"] --> CAP
  M3["③ 디지털 디자인 도구<br/>드로잉과 CAD · IOT인터페이스디자인 · UX·UI디자인 기초"] --> CAP
  M4["④ VMD·연출 기획<br/>VMD와 전시무대디자인 · VMD스튜디오 · 브랜드디자인"] --> CAP
  M5["⑤ 디스플레이·그래픽·조명<br/>가구디자인 · 브랜드숍디자인 · 패키지디자인"] --> CAP
  M6["⑥ AI 연출 비주얼라이제이션<br/>AI 공간디자인기초 · 디자인상품화스튜디오"] --> CAP
  M7["⑦ 관람 데이터·캡스톤<br/>전시디자인 스튜디오1 · 전시디자인 스튜디오2"] --> CAP
  CAP["VMD창업과 실무 캡스톤디자인<br/>종합 연출 · 캡스톤"]
```
