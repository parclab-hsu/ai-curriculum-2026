...
## 1. 개요
미디어디자인트랙은 디지털 미디어를 매개로 한 **몰입형 콘텐츠, 미디어아트, 인터랙티브·공간 디자인, 미디어 파사드, 전시·체험 콘텐츠**를 다룹니다. AI 융합 개편의 핵심 방향은 다음과 같습니다.
...
!!! abstract "이 트랙과 향후 10년 고용"
    ...
    - **시사점:** 생성형 AI를 '시안·에셋 생성 워크플로우'로 다루는 역량을 교육과정 핵심에 두면, 보완 대상 창의 직무로서의 경쟁력을 강화할 수 있다.
...
## 6. 교육과정 개편 시사점
1. **'AI 생성 + 실시간 3D' 통합 스튜디오 과목 신설**: Stable Diffusion/Runway로 에셋을 생성하고 언리얼·TouchDesigner로 인터랙티브 콘텐츠로 구현하는 end-to-end 프로젝트 과목.
