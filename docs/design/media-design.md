...
```mermaid
flowchart LR
  M1["① AI 디자인 리터러시<br/>AI와 UXD · AI와 HCI"] --> CAP
  M2["② 디자인 기초·조형<br/>기초미디어디자인 · 구조와 표현 · 타이포그래피"] --> CAP
  M3["③ 디자인 씽킹·UX 리서치<br/>디자인과인간심리 · 문화콘텐츠기획 · UXUI디자인 기초"] --> CAP
  M4["④ 인터랙션·미디어 영상<br/>영상디자인 · 모션그래픽 · 모바일인터페이스종합설계"] --> CAP
  M5["⑤ 생성형 미디어·실시간 3D<br/>메타버스와 XR융합콘텐츠 · 영상촬영 스튜디오 · 디지털 촬영 입문"] --> CAP
  M6["⑥ AI 기반 UX·콘텐츠 분석<br/>디지털 자원 큐레이션 · 인포그래픽 · AI 사용성 평가"] --> CAP
  CAP["미디어디자인종합설계 · 캡스톤"]
```
