...
| --- | --- | --- | --- | --- |
| AI 디자인 리터러시 | 단과대학공통 | 생성형 AI 비주얼·영상 도구, 프롬프트 디자인, 실시간 3D 기초, AI 저작권·윤리 | AI 도구로 시각·영상 산출물을 생성하고 윤리·저작권을 검토 | AI와 UXD, AI 저작권과 윤리(제안) |
| 디자인 기초·조형 | 학부공통 | 조형원리·타이포·색채·디지털 도구 | 디자인 기본 문법으로 시각 산출물 구성 | 기초미디어디자인, 구조와 표현 |
| 디자인 씽킹·UX 리서치 | 학부공통 | 사용자 리서치·문제정의·아이데이션 | 사용자 중심 설계 프로세스 수행 | 디지털과인간심리, 문화콘텐츠기획 |
| 인터랙션·UI 설계 | 트랙전공 | 인터랙션 패턴·UI 시스템·프로토타이핑 | 반응형 UI/인터랙션 프로토타입 제작 | AI와 HCI, 크리에이티브워크숍 |
| 생성형 미디어·실시간 3D | 트랙전공 | 프롬프트 기반 미디어 생성, 실시간 3D·제너러티브 | 생성형 미디어 인스톨레이션 구현 | 메타버스와 XR융합콘텐츠, 영상촬영 스튜디오 |
| AI 기반 UX 데이터 분석 | 트랙전공 | 사용자 데이터·행동분석·A/B 검증 | 데이터 근거 UX 의사결정 도출 | AI 사용성 평가(제안), UX 데이터 분석(제안) |
| 미디어 캡스톤 | 트랙전공 | 통합 프로젝트·산학 협업 | 인터랙티브 미디어/UX 완성작 산출 | 미디어디자인 캡스톤(제안) |
