...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Design/5175/subview.do](https://www.hansung.ac.kr/Design/5175/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.

| 모듈명 | 계층 | 핵심 역량·주제 | 학습 성과 | 대표 교과(공식/제안) |
| --- | --- | --- | --- | --- |
| AI 디자인 리터러시 | 단과대학공통 | 생성형 AI 비주얼 도구, 프롬프트 디자인, 데이터 기반 디자인, AI 저작권·윤리 | AI 도구로 디자인 대안을 생성·평가하고 윤리·저작권을 준수한다 | UXUI지식재산권 · AI 공간디자인기초 · AI 디자인기초(예시) · 프롬프트 디자인(예시) |
| 디자인 기초·시각조형 | 학부공통 | 조형 원리, 색채·타이포, 디자인 사고 | 디자인 기본 문법으로 시각 결과물을 구성한다 | 드로잉과 CAD · 컴퓨터그래픽 · 가구디자인 |
| 디지털 디자인 도구 | 학부공통 | 디지털 저작, UI 그래픽·이미지 처리 | 디지털 도구로 UI 자산을 제작·관리한다 | 컴퓨터응용디자인 · 제품서비스융합디자인 · 디자인상품화스튜디오 |
| UX 리서치·전략 | 트랙전공 | 사용자 조사, 페르소나·여정지도, 정보구조 | 사용자 인사이트를 UX 전략으로 변환한다 | UX 디자인의 이해 · UX·UI디자인 기초 · UXUI 디자인프로젝트1 |
| 인터랙션·UI 설계 | 트랙전공 | 와이어프레임, 인터랙션, 디자인 시스템 | 일관된 인터랙션·UI 시스템을 설계한다 | IOT인터페이스디자인 · UXUI 디자인스튜디오1 · UXUI 디자인스튜디오2 |
| AI 디자인 워크플로우 | 트랙전공 | AI UI 시안 생성, AI 보조 프로토타이핑, 프롬프트 시스템 | AI 워크플로우로 UI 시안·플로우를 고속 제작한다 | UX/UI 디자인프로젝트2 · Figma Make 생성형 프로토타이핑(예시) · v0·Figma MCP 워크플로(예시) |
| 데이터 기반 UX·캡스톤 | 트랙전공 | 사용성 테스트, 행동·A/B 데이터 분석, 종합 설계 | 데이터 근거 기반 종합 UX/UI를 완수·검증한다 | UX/UI 캡스톤디자인 · 디자인창업스튜디오 종합설계 · UX/UI 창업스튜디오 · UX 데이터 분석(예시) |
...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["디자인 입문<br/>드로잉과 CAD · 디자인 사고"]
    M1["① AI 디자인 리터러시<br/>UXUI지식재산권 · AI 공간디자인기초"]
    M2["② 디자인 기초·시각조형<br/>컴퓨터그래픽 · 가구디자인"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M3["③ 디지털 디자인 도구<br/>컴퓨터응용디자인 · 제품서비스융합디자인"]
    M4["④ UX 리서치·전략<br/>UX 디자인의 이해 · UXUI 디자인프로젝트1"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M5["⑤ 인터랙션·UI 설계<br/>UXUI 디자인스튜디오1 · UXUI 디자인스튜디오2"]
    M6["⑥ AI 디자인 워크플로우<br/>UX/UI 디자인프로젝트2 · Figma Make · v0·Figma MCP"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["⑦ 데이터 기반 UX·캡스톤<br/>UX/UI 캡스톤디자인 · 종합설계"]
  end
  A0 --> M2 --> M4 --> M5 --> M6 --> CAP
  M1 --> M6
  M3 --> M5
...
> 각 모듈의 학습 역량을 4장 요구 직무 역량과 직접 연결한 표다.

| 모듈 | 핵심 역량(학습) | 매핑되는 기업 요구 역량 |
| --- | --- | --- |
| ① AI 디자인 리터러시 | 생성형 AI 비주얼 도구, 프롬프트 디자인, AI 저작권·윤리 | (AI 융합) LLM 프롬프트 엔지니어링, '생성은 저렴·큐레이션이 가치'(문제정의·검증) |
| ② 디자인 기초·시각조형 | 조형 원리, 색채·타이포, 디자인 사고 | (핵심 직무) 시각 표현 기초, Figma 기반 화면 구성 |
| ③ 디지털 디자인 도구 | 디지털 저작, UI 그래픽·이미지 처리 | (핵심 직무) Figma(Auto Layout·Components·Variables), HTML/CSS(우대) |
| ④ UX 리서치·전략 | 사용자 조사, 페르소나·여정지도, 정보구조 | (AI 융합) 문제정의·검증(큐레이션) / (데이터) A/B 테스트 설계·해석 |
| ⑤ 인터랙션·UI 설계 | 와이어프레임, 인터랙션, 디자인 시스템 | (핵심 직무) 디자인시스템 구축·운영, PM·개발자 협업 |
| ⑥ AI 디자인 워크플로우 | AI UI 시안 생성, AI 보조 프로토타이핑, 프롬프트 시스템 | (AI 융합) Figma Make·v0·Galileo/Stitch·Relume, AI 에이전트 오케스트레이션, Figma MCP 워크플로 |
| ⑦ 데이터 기반 UX·캡스톤 | 사용성 테스트, 행동·A/B 데이터 분석, 종합 설계 | (데이터) GA4·Amplitude·Mixpanel, A/B 테스트 설계·해석 / (핵심 직무) PM·개발자 협업 |
