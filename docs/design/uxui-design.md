...
```mermaid
flowchart LR
  M1["① AI 디자인 리터러시<br/>UXUI지식재산권 · AI 공간디자인기초 · 프롬프트 디자인"] --> CAP
  M2["② 디자인 기초·시각조형<br/>드로잉과 CAD · 컴퓨터그래픽 · 가구디자인"] --> CAP
  M3["③ 디지털 디자인 도구<br/>컴퓨터응용디자인 · 제품서비스융합디자인 · 디자인상품화스튜디오"] --> CAP
  M4["④ UX 리서치·전략<br/>UX 디자인의 이해 · UX·UI디자인 기초 · UXUI 디자인프로젝트1"] --> CAP
  M5["⑤ 인터랙션·UI 설계<br/>IOT인터페이스디자인 · UXUI 디자인스튜디오1 · UXUI 디자인스튜디오2"] --> CAP
  M6["⑥ AI 디자인 워크플로우<br/>UX/UI 디자인프로젝트2 · Figma Make · v0·Figma MCP"] --> CAP
  M7["⑦ 데이터 기반 UX·캡스톤<br/>UX/UI 캡스톤디자인 · 종합설계 · UX 데이터 분석"] --> CAP
  CAP["종합설계 · 캡스톤"]
```
