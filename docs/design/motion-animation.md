...
> **AI융합디자인학부** 개편에 따라 영상애니메이션디자인트랙은 '영상·애니메이션·모션그래픽 + AI 영상 생성·버추얼 프로덕션'의 융합 트랙으로 재정의됩니다.

## 1. 개요

본 트랙은 **영상 제작·편집, 2D/3D 애니메이션, 모션그래픽, 광고·콘텐츠 영상**을 다룹니다. AI 융합 개편 방향은 다음과 같습니다.

- 텍스트→영상 생성형 AI(Sora·Runway·Kling류)를 기획·시안·제작 파이프라인에 도입
- 언리얼엔진 기반 **버추얼 프로덕션·실시간 렌더링** 제작 역량 확보
- 'AI가 만드는 영상'이 늘수록 더 중요해지는 **기획력·스토리텔링** 강화

## 2. 산업·기술 트렌드 (2024–2026)

- **AI 영상 생성 기술 급발전**: 2025년 9월 OpenAI **Sora 2** 발표로 자연스러운 2D 애니메이션 생성 가능성 입증. 2026년 초 중국 **클링 3(멀티샷)·시댄스 2(액션신)** 등장으로 경쟁 가속.
...
!!! abstract "이 트랙과 향후 10년 고용"
    ...
    - **미국(BLS)·글로벌(WEF):** WEF 2025는 AI/ML·소프트웨어 개발을 성장 직군으로 보며 AI가 기업 86%를 전환시킨다고 분석, AI 영상 생성 도구를 다루는 모션·애니메이션 인력 수요 확대를 뒷받침한다.
...
| --- | --- | --- |
| 영상 기획·연출·편집, 스토리텔링 | 텍스트→영상 생성(Sora/Runway/Kling) | Premiere Pro, After Effects |
...
1. **'AI 영상 생성 + 버추얼 프로덕션' 통합 과목**: Runway·Sora·Kling로 시퀀스를 생성하고 언리얼엔진으로 실사·실시간 합성하는 제작 파이프라인 실습.
...
- 모션테크놀로지 언리얼 버추얼 프로덕션 개발자 채용(게임잡) / 자이언트스텝 채용
- 펄어비스 게임 공식 채널 영상 디자이너 공고(잡코리아)
- AI 모션그래픽 자동 제작 가이드 2026 / 한국데이터경제신문 AI 채용 통계
...
| --- | --- | --- | --- | --- |
| AI 디자인 리터러시 | 단과대학공통 | 생성형 AI 비주얼·영상 도구, 프롬프트 디자인, 실시간 3D 기초, AI 저작권·윤리 | AI 도구로 영상·이미지 산출물을 생성하고 윤리·저작권을 검토 | 생성형AI디자인기초, AI저작권과윤리 |
| 디자인 기초·조형 | 학부공통 | 조형·드로잉·색채·디지털 도구 | 시각 표현 기본 문법 구성 | 기초조형, 디지털드로잉 |
| 스토리텔링·디자인 씽킹 | 학부공통 | 내러티브·기획·문제정의 | 스토리 중심 기획 프로세스 수행 | 영상스토리텔링, 디자인씽킹 |
| 모션그래픽·영상편집 | 트랙전공 | 모션 원리·타이밍·편집·합성 | 모션그래픽/편집 시퀀스 제작 | 모션그래픽, 영상편집과합성 |
| 2D·3D 애니메이션 | 트랙전공 | 캐릭터·키프레임·리깅·실시간 3D | 애니메이션 시퀀스 제작 | 2D애니메이션, 3D애니메이션 |
| 생성형 영상·프롬프트 연출 | 트랙전공 | 프롬프트 기반 영상·컨셉아트 생성, AI 워크플로우 | 의도한 톤의 생성형 영상 시퀀스 산출 | 생성형영상제작, AI컨셉아트워크숍 |
| 영상애니메이션 캡스톤 | 트랙전공 | 통합 단편 제작·산학/공모전 협업 | 완성 단편 작품 산출 | 영상애니메이션캡스톤 |
