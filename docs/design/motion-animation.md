...
```mermaid
flowchart LR
  M1["① AI 디자인 리터러시<br/>AI 영상·이미지 제작 스튜디오 · AI 그래픽스 스튜디오"] --> CAP
  M2["② 디자인 기초·조형<br/>영상애니메이션 기초 · 컴퓨터그래픽 · 만화 조형과 색채연구"] --> CAP
  M3["③ 스토리텔링·디자인 씽킹<br/>만화 웹툰 창작 · 디자인컨셉 · 문화콘텐츠기획"] --> CAP
  M4["④ 모션그래픽·영상편집<br/>디지털 영상 합성 · 영상촬영 스튜디오 · 컴퓨터 특수시각효과"] --> CAP
  M5["⑤ 2D·3D 애니메이션<br/>디지털애니메이션 동작표현 · 게임 3D 그래픽 · 캐릭터 개발 프로세스"] --> CAP
  M6["⑥ 생성형 영상·인터랙티브<br/>AI게임페인팅기법연구2 · 인터랙티브 미디어 · 메타버스와 XR융합콘텐츠"] --> CAP
  CAP["영상애니메이션 캡스톤디자인 · 종합 설계"]
```
