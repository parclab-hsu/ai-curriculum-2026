...
| --- | --- | --- | --- | --- |
| AI 디자인 리터러시 | 단과대학공통 | 생성형 AI 비주얼·영상 도구, 프롬프트 디자인, 실시간 3D 기초, AI 저작권·윤리 | AI 도구로 영상·이미지 산출물을 생성하고 윤리·저작권을 검토 | AI 디자인 리터러시(제안), AI 저작권과 윤리(제안) |
| 디자인 기초·조형 | 학부공통 | 조형·드로잉·색채·디지털 도구 | 시각 표현 기본 문법 구성 | 영상애니메이션 기초, 컴퓨터그래픽 |
| 스토리텔링·디자인 씽킹 | 학부공통 | 내러티브·기획·문제정의 | 스토리 중심 기획 프로세스 수행 | 만화(웹툰) 창작, 디자인컨셉 |
| 모션그래픽·영상편집 | 트랙전공 | 모션 원리·타이밍·편집·합성 | 모션그래픽/편집 시퀀스 제작 | 디지털 영상 합성, 영상촬영 스튜디오 |
| 2D·3D 애니메이션 | 트랙전공 | 캐릭터·키프레임·리깅·실시간 3D | 애니메이션 시퀀스 제작 | 디지털애니메이션 동작표현, 게임 드로잉기법연구1 |
| 생성형 영상·프롬프트 연출 | 트랙전공 | 프롬프트 기반 영상·컨셉아트 생성, AI 워크플로우 | 의도한 톤의 생성형 영상 시퀀스 산출 | AI 영상·이미지 제작 스튜디오, AI 그래픽스 스튜디오 |
| 영상애니메이션 캡스톤 | 트랙전공 | 통합 단편 제작·산학/공모전 협업 | 완성 단편 작품 산출 | 가상현실 애니메이션 캡스톤디자인 |
