...
> 학문 분야 정체성: 영상애니메이션디자인트랙은 모션그래픽·애니메이션·영상 연출을 통해 시간 기반 스토리를 시각화하는 분야로, 생성형 AI 영상·이미지 도구를 활용해 기획·제작·후반작업의 효율과 표현 폭을 확장하는 영상 디자이너를 양성합니다.
...
!!! info "진출 직무 — 이런 전문가로 성장할 수 있어요"
    ...
    - **모션그래픽 디자이너 (경로 A):** 글자·도형·영상에 리듬과 타이밍을 입혀 브랜드 광고와 콘텐츠를 눈을 뗄 수 없게 만드는 영상 연출가입니다. 내가 짠 한 컷의 모션이 유튜브·전광판·앱 인트로에서 수많은 사람의 시선을 사로잡는 순간을 직접 경험할 수 있습니다. → *AI 활용 능력·역량:* 텍스트로 영상 시안을 생성하고 반복 편집을 자동화해 제작 속도와 표현 폭을 함께 끌어올리는 **생성형 영상 워크플로우 운용 역량**.
    - **애니메이터 (경로 B):** 캐릭터에 숨결과 연기를 불어넣어 관객이 감정 이입하는 2D·3D 애니메이션 장면을 완성하는 창작자입니다. 내가 움직인 캐릭터가 화면에서 살아 움직이며 이야기를 전하는 성취를 온전히 맛볼 수 있습니다. → *AI 활용 능력·역량:* 컨셉아트·중간 프레임을 생성해 밑그림을 빠르게 잡고 표현의 한계를 넓히는 **AI 애니메이션 제작 역량**.
    - **브랜디드 콘텐츠 PD·광고영상 디렉터 (경로 C):** 브랜드 캠페인 영상을 기획부터 연출·제작까지 진두지휘하며 '팔리는 이야기'를 만들어 내는 총괄자입니다. 내 손끝에서 시작된 아이디어가 하나의 캠페인이 되어 시장에 반응을 일으키는 짜릿함을 누릴 수 있습니다. → *AI 활용 능력·역량:* 스토리보드·시안 영상을 즉시 생성해 기획 방향을 미리 검증하고 조율하는 **AI 기반 영상 기획·연출 역량**.
    - **버추얼 프로덕션 아티스트·AI 테크 디렉터(TD) (경로 D):** 언리얼엔진 실시간 도구로 가상 세트를 짓고 촬영·합성 파이프라인을 설계·운영하는 제작 현장의 기술 사령탑입니다. 영화·드라마 촬영장에서 배우 뒤 LED 월에 내가 만든 세계가 실시간으로 펼쳐지는 최전선을 경험할 수 있습니다. → *AI 활용 능력·역량:* 실시간 3D·합성·후반작업 도구를 연결해 제작 흐름을 자동화하고 기술 문제를 해결하는 **버추얼 프로덕션 파이프라인 설계 역량**.

### 10-5. 상위 수준 보완 권고

> 아래는 한국예술종합학교 영상원·청강문화산업대학 애니메이션콘텐츠스쿨·계원예술대학교 애니메이션과 등 영상·애니메이션 제작 특성화 **상위 비교군** 및 산업 표준 정렬을 위한 **보완 권고**입니다. **공식 교과를 대체하지 않으며**, 2027학년도 교과 개편 시 심의 의견·향후 개선 계획으로 활용합니다.
