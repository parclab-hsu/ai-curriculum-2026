...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["뷰티디자인 입문<br/>미용학개론 · 뷰티트렌드 메이크업"]
    M1["① AI 디자인 리터러시<br/>뷰티응용그래픽 · 뷰티소셜미디어"]
    M2["② 뷰티디자인 기초·조형<br/>뷰티이미지메이킹 · 살롱헤어"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M3["③ AI 피부진단·퍼스널컬러<br/>살롱테라피 · 두피모발케어"]
    M4["④ AR 뷰티 트라이온·콘텐츠<br/>아트캐릭터 메이크업 · 뷰티 사진"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M5["⑤ 맞춤형 화장품·뷰티테크<br/>뷰티테크 · 뷰티작품기획"]
    M6["⑥ 뷰티 브랜드·매니지먼트<br/>뷰티이커머스마케팅 · 뷰티프로젝트"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["캡스톤<br/>뷰티아트 캡스톤디자인 · 뷰티 브랜드 캡스톤디자인"]
  end
  A0 --> M2 --> M3 --> M5 --> M6 --> CAP
  M1 --> M4
  M4 --> M5
...
| --- | --- | --- |
| ① AI 디자인 리터러시 | 생성형 AI 비주얼 도구, 프롬프트 디자인, AI 저작권·윤리 | (AI 융합) 생성형 AI 비주얼/카피 제작 / (툴) 생성형 AI 툴 |
| ② 뷰티디자인 기초·조형 | 색채·조형 원리, 뷰티 미학, 얼굴·신체 비례 | (핵심 직무) 색채·조형 감각, 메이크업·스킨케어·헤어 실무 |
| ③ AI 피부진단·퍼스널컬러 | AI 피부진단 데이터 해석, 퍼스널컬러 AI, 맞춤형 진단 설계 | (AI 융합) AI 피부진단 데이터 해석, 퍼스널컬러 AI / (핵심 직무) 퍼스널 컬러 진단 |
| ④ AR 뷰티 트라이온·콘텐츠 | AR 가상 메이크업·헤어, 생성형 비주얼 콘텐츠, 뷰티 영상 | (AI 융합) AR 트라이온, 생성형 AI 비주얼 / (툴) Premiere·After Effects |
| ⑤ 맞춤형 화장품·뷰티테크 | 성분·피부 데이터, 개인화 화장품 기획, 뷰티 디바이스 | (AI 융합) 맞춤형 화장품 조제 데이터, 뷰티테크 디바이스 운용 / (자격) 맞춤형화장품 조제관리사 |
| ⑥ 뷰티 브랜드·매니지먼트 | 뷰티 브랜딩, 매장·서비스 운영, 데이터 마케팅 | (핵심 직무) 브랜드/패키지·비주얼 디자인, VMD·매장 연출, 고객 컨설팅 |
| 캡스톤(뷰티아트·브랜드·살롱에스테틱) | 종합 기획·제작·운영, 산학 협업 | (AI 융합) 초개인화 추천 로직 / (핵심 직무) 전 직무 통합 완성 |
