...
> 출처: 한성대학교 뷰티디자인매니지먼트학과 공식 교과과정([https://www.hansung.ac.kr/Design/5189/subview.do](https://www.hansung.ac.kr/Design/5189/subview.do)) 기준, 확인일 2026-06-30. 구성 교과목 공식, 미존재 보강은 (예시). (전기=전공기초·전필=전공필수·전선=전공선택)

| 모듈 | 모듈명 | 구성 교과목 (학년-학기·이수구분) | 모듈 설명 | 모듈 학습성과 | 모듈 간 관계 |
| --- | --- | --- | --- | --- | --- |
| **M1** | AI 디자인 리터러시 | 뷰티응용그래픽(4-1·전선) · 뷰티소셜미디어(3-1·전선) · 생성형 AI 디자인 입문(예시·학기 미상) · AI 디자인 윤리·저작권(예시·학기 미상) | 생성형 AI 비주얼 도구, 프롬프트 디자인, 데이터 기반 디자인, AI 저작권·윤리 | 생성형 AI 도구로 디자인 시안을 제작하고 윤리·저작권을 준수해 활용한다 | 단과대학 공통·선이수 |
| **M2** | 뷰티디자인 기초·조형 | 미용학개론(3-2·전선) · 뷰티이미지메이킹(3-1·전선) · 살롱헤어(3-2·전선) · 뷰티트렌드 메이크업(3-1·전선) | 색채·조형 원리, 뷰티 미학, 얼굴·신체 비례, 디자인 기초 | 뷰티디자인의 미적 원리를 이해하고 기초 룩을 설계한다 | 학과 전공기초 |
| **M3** | AI 피부진단·퍼스널컬러 | 살롱테라피(3-1·전선) · 두피모발케어(3-2·전선) · 트리콜로지스트(4-1·전선) · AI 피부진단 실무(예시·학기 미상) | AI 피부진단 데이터 해석, 퍼스널컬러 AI, 맞춤형 진단 설계 | 진단 데이터를 해석해 개인 맞춤형 스킨케어·컬러 솔루션을 제안한다 | M3·M5 마이크로디그리 |
| **M4** | AR 뷰티 트라이온·콘텐츠 | 아트캐릭터 메이크업(3-2·전선) · 살롱헤어 컬러(3-1·전선) · 뷰티 사진(4-2·전선) · AR 뷰티 시뮬레이션(예시·학기 미상) | AR 가상 메이크업·헤어, 생성형 비주얼 콘텐츠, 뷰티 영상 | AR·생성형 AI로 뷰티 룩을 시각화하고 디지털 콘텐츠를 제작한다 | 시각디자인 교차수강 |
| **M5** | 맞춤형 화장품·뷰티테크 | 뷰티테크(4-2·전선) · 뷰티작품기획(4-1·전선) · 맞춤형 화장품 기획(예시·학기 미상) · 화장품 성분·과학(예시·학기 미상) | 성분·피부 데이터, 개인화 화장품 기획, 뷰티 디바이스 | 데이터 기반으로 맞춤형 화장품·뷰티테크 서비스를 기획한다 | M3·M5 마이크로디그리 |
| **M6** | 뷰티 브랜드·매니지먼트 | 뷰티이커머스마케팅(3-2·전선) · 뷰티외국어(3-1·전선) · 뷰티프로젝트(4-2·전선) · 뷰티 브랜드 캡스톤디자인1(4-1·전선) | 뷰티 브랜딩, 매장·서비스 운영, 데이터 마케팅, 창업 | 데이터를 활용해 뷰티 브랜드·매장 서비스를 기획·운영한다 | 종합·캡스톤 |
