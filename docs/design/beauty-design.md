...
> **학문 분야 정체성:** 뷰티디자인은 인간의 외적 아름다움과 자기표현을 메이크업·스킨케어·헤어·뷰티 매니지먼트의 미적·과학적 원리로 설계하고, 개인과 시대의 라이프스타일에 맞는 가치를 창출하는 응용 디자인 학문입니다.

뷰티디자인매니지먼트학과(2027 개편/제안명 'AI뷰티디자인학과')는 전통적 뷰티디자인의 전공 정체성(메이크업·스킨케어·헤어·뷰티 매니지먼트)을 핵심으로 유지하면서, 생성형 AI와 뷰티테크를 결합하여 데이터 기반 맞춤형 뷰티 솔루션을 설계할 수 있는 융합 인재를 양성합니다.
...
!!! info "진출 직무 — 이런 전문가로 성장할 수 있어요"
    ...
    - **뷰티테크 기획자 (경로 A):** AI 피부진단·맞춤형 화장품처럼 뷰티와 기술이 만나는 서비스를 어떤 기능으로 구현할지 설계하는, K-뷰티 산업의 성장을 이끄는 기획자입니다. 룰루랩·아모레퍼시픽 같은 곳에서 내가 기획한 뷰티테크 서비스가 수백만 고객의 피부 고민을 풀어 주는 성취를 경험할 수 있습니다. → *AI 활용 능력·역량:* 피부 진단 데이터를 해석해 개인 맞춤 제품·서비스를 설계하는 **AI 뷰티 데이터 기획 역량**.
    - **뷰티 콘텐츠 아트디렉터 (경로 B):** 뷰티 브랜드의 광고·SNS 영상 콘텐츠의 비주얼 방향을 잡고 제작을 이끄는, 브랜드의 첫인상을 디자인하는 크리에이티브 리더입니다. 내가 만든 뷰티 룩과 캠페인이 브랜드의 얼굴이 되어 사람들에게 퍼져 나가는 성취를 누릴 수 있습니다. → *AI 활용 능력·역량:* AR 트라이온과 생성형 AI 비주얼로 룩·캠페인 시안을 신속히 제작하는 **생성형 AI 뷰티 콘텐츠 제작 역량**.
    - **퍼스널컬러·뷰티 컨설턴트(뷰티 매장 매니저) (경로 C):** 고객의 피부와 컬러를 직접 진단해 가장 어울리는 제품을 추천하고 매장을 이끄는, 고객이 가장 신뢰하는 뷰티 파트너입니다. 내 컨설팅으로 고객이 달라진 자신의 모습에 기뻐하는 순간을 눈앞에서 마주하는 보람을 경험할 수 있습니다. → *AI 활용 능력·역량:* 퍼스널컬러 AI·피부진단 결과로 데이터 근거 맞춤 큐레이션을 제안하는 **데이터 기반 뷰티 컨설팅 역량**.
    - **뷰티 브랜드 창업가(인디브랜드 상품기획자) (경로 D):** 자기만의 콘셉트로 화장품 라인을 기획하고 브랜드를 세워 세상에 내놓는, K-뷰티 3.0 시대의 주인공입니다. 내 손에서 탄생한 브랜드가 실제 시장에서 팔리고 팬을 만드는, 창업가만이 누리는 성취를 경험할 수 있습니다. → *AI 활용 능력·역량:* 성분·구매 데이터를 AI로 분석해 제품 기획과 D2C 마케팅에 활용하는 **데이터 기반 뷰티 상품기획 역량**.

### 10-5. 상위 수준 보완 권고

> 아래는 서경대 뷰티테라피&메이크업·건국대(글로컬) 향장학·한국폴리텍 뷰티케어과 등 뷰티계열 특성화 학과와 아모레퍼시픽·LG생활건강 산학 표준을 **상위 비교군**으로 한 뷰티디자인·뷰티테크 산업 표준 정렬용 **보완 권고**입니다. **공식 교과를 대체하지 않으며**, 2027학년도 교과 개편 시 심의 의견·향후 개선 계획으로 활용합니다.
