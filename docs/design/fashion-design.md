...
```mermaid
flowchart LR
  M1["① AI 디자인 리터러시<br/>AI 패션디자인 프로세스 · 패션CAD"] --> CAP
  M2["② 패션산업·소비자 이해<br/>패션마케팅 · 서양복식사 · 패션디자인"] --> CAP
  M3["③ 패션 데이터 분석 기초<br/>패션CAD · 패턴CAD"] --> CAP
  M4["④ 디자인 기초조형<br/>패션드로잉기초 · 패션일러스트레이션 · 칼라스튜디오"] --> CAP
  M5["⑤ 패션디자인 전개<br/>패션디자인 · 의복구성 · 어패럴패턴디자인 · 드레이핑"] --> CAP
  M6["⑥ AI 비주얼·텍스타일 디자인<br/>AI 패션디자인 프로세스 · 니트디자인"] --> CAP
  M7["⑦ 3D 가상의상·디지털 패션<br/>테크니컬디자인 · 패턴CAD · 토탈패션소품개발"] --> CAP
  CAP["패션디자인포트폴리오 · 졸업 컬렉션 캡스톤"]
```
