...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/Design/5112/subview.do](https://www.hansung.ac.kr/Design/5112/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.

| 모듈명 | 계층 | 핵심 역량·주제 | 학습 성과 | 대표 교과(공식 3~4과목) |
| --- | --- | --- | --- | --- |
| AI 디자인 리터러시 | 단과대학공통 | 생성형 AI 비주얼 도구, 프롬프트 디자인, AI 저작권·윤리, 데이터 기반 디자인 기초 | 디자인 맥락에서 AI 도구를 책임 있게 활용하고 윤리·저작권을 판단한다 | AI 패션디자인 프로세스 · 패션CAD · AI디자인리터러시(예시) |
| 패션산업·소비자 이해 | 학부공통 | 패션산업 구조, 소비자행동, 트렌드 분석 | 산업 가치사슬과 소비자 의사결정을 설명하고 트렌드를 해석한다 | 패션마케팅 · 서양복식사 · 패션디자인 |
| 패션 데이터 분석 기초 | 학부공통 | 디자인·색채·트렌드 데이터 수집·시각화 | 디자인 의사결정에 필요한 데이터를 정제·해석한다 | 패션CAD · 패턴CAD · 패션데이터분석입문(예시) · 색채데이터분석(예시) |
| 디자인 기초조형 | 트랙전공 | 조형원리, 색채, 드로잉, 발상 | 조형·색채 원리를 적용해 디자인 발상을 전개한다 | 패션드로잉기초 · 패션일러스트레이션 · 칼라스튜디오 · 디자인스케치 |
| 패션디자인 전개 | 트랙전공 | 컬렉션 기획, 입체재단, 패턴, 소재기획 | 콘셉트에서 실물 의상까지 디자인을 전개·구현한다 | 패션디자인 · 의복구성 · 어패럴패턴디자인 · 드레이핑 |
| AI 비주얼·텍스타일 디자인 | 트랙전공 | 생성형 AI 이미지, AI 텍스타일·프린트, 무드보드 | 생성형 AI로 디자인 베리에이션·텍스타일을 제작한다 | AI 패션디자인 프로세스 · 패션CAD · 니트디자인 |
| 3D 가상의상·디지털 패션 | 트랙전공 | 3D 의상 시뮬레이션, 디지털 트윈, 가상 피팅 | 디자인을 3D로 시각화·검증하고 디지털 컬렉션을 제작한다 | 테크니컬디자인 · 패턴CAD · 토탈패션소품개발 캡스톤디자인 · 3D가상의상(예시) |
...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["① AI 디자인 리터러시<br/>AI 패션디자인 프로세스 · 패션CAD"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M2["② 패션산업·소비자 이해<br/>패션마케팅 · 서양복식사"]
    M3["③ 패션 데이터 분석 기초<br/>패션CAD · 패턴CAD"]
    M4["④ 디자인 기초조형<br/>패션드로잉기초 · 패션일러스트레이션 · 칼라스튜디오"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M5["⑤ 패션디자인 전개<br/>패션디자인 · 의복구성 · 드레이핑"]
    M6["⑥ AI 비주얼·텍스타일 디자인<br/>AI 패션디자인 프로세스 · 니트디자인"]
    M7["⑦ 3D 가상의상·디지털 패션<br/>테크니컬디자인 · 패턴CAD"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["캡스톤<br/>패션디자인포트폴리오 · 졸업 컬렉션"]
  end
  A0 --> M4
  M2 --> M5
  M3 --> M7
...
| --- | --- | --- |
| ① AI 디자인 리터러시 | 생성형 AI 비주얼 도구·프롬프트·AI 저작권/윤리 | 생성형 AI 시안·무드보드 발상 |
| ② 패션산업·소비자 이해 | 패션산업 구조·소비자행동·트렌드 분석 | 컬러·트렌드 분석 (AI 트렌드 리서치 활용) |
| ③ 패션 데이터 분석 기초 | 디자인·색채·트렌드 데이터 수집·해석 | 수요예측·트렌드 데이터 해석 |
| ④ 디자인 기초조형 | 조형원리·색채·드로잉·발상 | 의상·컬렉션 디자인 · 컬러 분석 |
| ⑤ 패션디자인 전개 | 컬렉션 기획·입체재단·패턴·소재기획 | 의상·컬렉션 디자인, 패턴 설계 · 소재·핏·드레이프 이해 |
| ⑥ AI 비주얼·텍스타일 디자인 | 생성형 AI 이미지·텍스타일·프린트 | 텍스타일·그래픽 디자인 (AI 텍스처·프린트 생성) |
| ⑦ 3D 가상의상·디지털 패션 | 3D 의상 시뮬레이션·디지털 트윈·가상 피팅 | 3D 의상 구현·가상 샘플링 (디지털 트윈/가상 피팅) |
| 캡스톤 | 졸업 컬렉션·AI 협업 디자인 통합 구현 | 의상·컬렉션 디자인 (통합 구현·포트폴리오) |
