...
| 패션산업·소비자 이해 | 학부공통 | 패션산업 구조, 소비자행동, 트렌드 분석 | 산업 가치사슬과 소비자 의사결정을 설명하고 트렌드를 해석한다 | 패션마케팅, 서양복식사 |
| 패션 데이터 분석 기초 | 학부공통 | 디자인·색채·트렌드 데이터 수집·시각화 | 디자인 의사결정에 필요한 데이터를 정제·해석한다 | 패션데이터분석입문(제안), 색채데이터분석(제안) |
| 디자인 기초조형 | 트랙전공 | 조형원리, 색채, 드로잉, 발상 | 조형·색채 원리를 적용해 디자인 발상을 전개한다 | 패션드로잉기초, 칼라스튜디오, 패션일러스트레이션 |
| 패션디자인 전개 | 트랙전공 | 컬렉션 기획, 입체재단, 패턴, 소재기획 | 콘셉트에서 실물 의상까지 디자인을 전개·구현한다 | 패션디자인, 의복구성, 어패럴패턴디자인, 드레이핑 |
| AI 비주얼·텍스타일 디자인 | 트랙전공 | 생성형 AI 이미지, AI 텍스타일·프린트, 무드보드 | 생성형 AI로 디자인 베리에이션·텍스타일을 제작한다 | AI 패션디자인 프로세스, 패션CAD |
| 3D 가상의상·디지털 패션 | 트랙전공 | 3D 의상 시뮬레이션, 디지털 트윈, 가상 피팅 | 디자인을 3D로 시각화·검증하고 디지털 컬렉션을 제작한다 | 3D가상의상(제안), 디지털패션스튜디오(제안) |
