...
flowchart LR
  ...
  M2["② 디자인 기초·조형<br/>게임그래픽기초 · 회화워크샵 · 타이포그래피"] --> CAP
  M3["③ 스토리텔링·디자인 씽킹<br/>영상디자인 · 영상커뮤니케이션"] --> CAP
  M4["④ 게임 컨셉아트·캐릭터<br/>게임 드로잉기법연구1 · 콘셉트아트1 · 게임캐릭터콘셉트아트"] --> CAP
  M5["⑤ 3D 에셋·실시간 렌더링<br/>게임3D그래픽기초 · 게임 3D 그래픽 · 컴퓨터그래픽"] --> CAP
  M6["⑥ 생성형 게임아트·프롬프트 파이프라인<br/>AI게임배경콘셉트디자인 · AI게임페인팅기법연구2"] --> CAP
  M7["⑦ 게임그래픽 캡스톤<br/>가상현실 애니메이션 캡스톤디자인 · 게임그래픽콘텐츠워크샵"] --> CAP
  CAP["게임그래픽 캡스톤디자인<br/>플레이어블 · 캡스톤"]
```
