...
!!! abstract "이 트랙과 향후 10년 고용"
    ...
    - **미국(BLS)·글로벌(WEF):** 미국 컴퓨터·수학직 2024~2034 +10.1% 성장, WEF는 SW개발·AI/ML을 성장 직군으로 꼽아 콘텐츠·소프트웨어 결합형 그래픽 직무에 우호적이다. 다만 WEF는 스킬 39% 진부화를 경고한다.
...
- **경로 D — 생성형 AI 게임 아티스트(R&D)**: 1학년 기초조형·AI 디자인 리터러시 → 2학년 게임컨셉아트·AI저작권과윤리 → 3학년 생성형게임아트·AI에셋파이프라인(LoRA 커스텀 학습·이미지투이미지) → 4학년 VARCO식 사내 AI 도구 환경 가정 AI 에셋 파이프라인 캡스톤으로 생성형 AI 아티스트로 진출.
