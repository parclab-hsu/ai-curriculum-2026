...
> 출처: 한성대학교 게임그래픽디자인트랙 공식 교과과정([https://www.hansung.ac.kr/Design/5168/subview.do](https://www.hansung.ac.kr/Design/5168/subview.do)) 기준, 확인일 2026-06-30. 구성 교과목 공식, 미존재 보강은 (예시). (전기=전공기초·전필=전공필수·전선=전공선택)

| 모듈 | 모듈명 | 구성 교과목 (학년-학기·이수구분) | 모듈 설명 | 모듈 학습성과 | 모듈 간 관계 |
| --- | --- | --- | --- | --- | --- |
| **M1** | AI 디자인 리터러시 | AI 영상·이미지 제작 스튜디오(2-1·전선) · AI게임디자인&아트(2-1·전필) · AI 그래픽스 스튜디오(2-2·전선) · AI저작권과윤리(예시) | 생성형 AI 비주얼·영상 도구, 프롬프트 디자인, 실시간 3D 기초, AI 저작권·윤리 | AI 도구로 비주얼·3D 산출물을 생성하고 윤리·저작권을 검토 | 전공기초·선이수 |
| **M2** | 디자인 기초·조형 | 게임그래픽기초(1-2·전기) · 회화워크샵(2-1·전선) · 타이포그래피(2-2·전선) · 디자인컨셉(2-1·전선) | 조형·드로잉·색채·디지털 도구 | 시각 표현 기본 문법 구성 | 전공기초학습 |
| **M3** | 스토리텔링·디자인 씽킹 | 영상디자인(2-2·전선) · 영상커뮤니케이션(2-2·전선) · 게임스토리텔링(예시) · 디자인씽킹(예시) | 세계관·내러티브·기획·문제정의 | 게임 세계관 중심 기획 수행 | 전공기초학습 |
| **M4** | 게임 컨셉아트·캐릭터 | 게임 드로잉기법연구1(2-1·전선) · 콘셉트아트1(2-2·전필) · 콘셉트아트2(3-1·전필) · 게임캐릭터콘셉트아트(2-2·전필) | 컨셉·캐릭터·환경 디자인·아트 디렉션 | 일관된 컨셉아트/캐릭터 세트 산출 | M4→M5 선수 |
| **M5** | 3D 에셋·실시간 렌더링 | 게임3D그래픽기초(2-1·전필) · 게임 3D 그래픽(3-2·전선) · 컴퓨터그래픽(2-2·전선) · 디지털애니메이션 동작표현(2-1·전선) | 3D 모델링·텍스처·게임 엔진·실시간 3D | 게임 엔진용 3D 에셋 제작·통합 | M5→M7 종합 |
| **M6** | 생성형 게임아트·프롬프트 파이프라인 | AI게임배경콘셉트디자인(2-2·전필) · AI게임페인팅기법연구2(3-1·전선) · 인터랙티브 미디어(3-1·전선) · 메타버스와 XR융합콘텐츠(3-2·전선) | 프롬프트 기반 컨셉/텍스처/3D 생성, AI 에셋 워크플로우(실습 도구: Stable Diffusion·ComfyUI 등) | AI 활용 게임 에셋 파이프라인 구축 | M6→M7 심화 |
| **M7** | 게임그래픽 캡스톤 | 게임그래픽 캡스톤디자인(4-1·전필) · 가상현실 애니메이션 캡스톤디자인(1-1·전선) · 그래픽디자인-캡스톤디자인(3-2·전선) · 게임그래픽콘텐츠워크샵(4-2·전필) | 통합 게임 비주얼·플레이어블 제작·산학/게임잼 | 게임 비주얼/프로토타입 완성작 산출 | 기존 모듈 역량 종합 검증 |

### 10-2. 모듈형 교육과정 로드맵 (학년·학기)

공식 교과목이 **언제 개설되는지**(학년-학기)를 한눈에 보여준다. (예시) 교과목은 제외.
