...
| --- | --- | --- | --- | --- |
| AI 디자인 리터러시 | 단과대학공통 | 생성형 AI 비주얼·영상 도구, 프롬프트 디자인, 실시간 3D 기초, AI 저작권·윤리 | AI 도구로 비주얼·3D 산출물을 생성하고 윤리·저작권을 검토 | 생성형AI디자인기초(제안), AI저작권과윤리(제안) |
| 디자인 기초·조형 | 학부공통 | 조형·드로잉·색채·디지털 도구 | 시각 표현 기본 문법 구성 | 게임그래픽기초, 회화워크샵 |
| 스토리텔링·디자인 씽킹 | 학부공통 | 세계관·내러티브·기획·문제정의 | 게임 세계관 중심 기획 수행 | 게임스토리텔링(제안), 디자인씽킹(제안) |
| 게임 컨셉아트·캐릭터 | 트랙전공 | 컨셉·캐릭터·환경 디자인·아트 디렉션 | 일관된 컨셉아트/캐릭터 세트 산출 | 디자인컨셉, 게임 드로잉기법연구1, AI게임배경콘셉트디자인 |
| 3D 에셋·실시간 렌더링 | 트랙전공 | 3D 모델링·텍스처·게임 엔진·실시간 3D | 게임 엔진용 3D 에셋 제작·통합 | 게임3D그래픽기초, 컴퓨터그래픽, 디지털애니메이션 동작표현 |
| 생성형 게임아트·프롬프트 파이프라인 | 트랙전공 | 프롬프트 기반 컨셉/텍스처/3D 생성, AI 에셋 워크플로우(실습 도구: Stable Diffusion·ComfyUI 등) | AI 활용 게임 에셋 파이프라인 구축 | AI게임디자인&아트, AI 그래픽스 스튜디오, AI 영상이미지 제작 스튜디오, 영상디자인 |
| 게임그래픽 캡스톤 | 트랙전공 | 통합 게임 비주얼·플레이어블 제작·산학/게임잼 | 게임 비주얼/프로토타입 완성작 산출 | 가상현실 애니메이션 캡스톤디자인 |
