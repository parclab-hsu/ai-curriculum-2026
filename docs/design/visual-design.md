...
- **BX 전반의 AI 실험**: 2025년부터 브랜드 경험 영역에서 생성형 AI(Midjourney, Kling, Figma Make 등)를 활용한 워크플로우 설계가 채용 우대·필수 요건으로 등장.
...
## 7. 출처
- 민병철유폰 AI 전문 UX/UI/BX 디자이너 공고(디자이너잡)
- 멋쟁이사자처럼 BX 디자이너 채용 / 빅링크 생성형 AI UX/UI 채용(잡코리아)
- 네이버 UX/UI 디자이너 채용(캐치) / 한국데이터경제신문 AI 채용·연봉 통계
- '디자인 회사에서 드디어 프롬프트 디자이너를 고용하다'(브런치)
...
| --- | --- | --- | --- | --- |
| AI 디자인 리터러시 | 단과대학공통 | 생성형 AI 비주얼·영상 도구, 프롬프트 디자인, 실시간 3D 기초, AI 저작권·윤리 | AI 도구로 시각 산출물을 생성하고 윤리·저작권을 검토 | 생성형AI디자인기초, AI저작권과윤리 |
| 디자인 기초·조형 | 학부공통 | 조형원리·타이포·색채·디지털 도구 | 디자인 기본 문법으로 시각 산출물 구성 | 기초조형, 타이포그래피1 |
| 디자인 씽킹·UX 리서치 | 학부공통 | 사용자·시장 리서치·문제정의 | 사용자/브랜드 중심 설계 프로세스 수행 | 디자인씽킹, 디자인리서치 |
| 편집·정보디자인 | 트랙전공 | 그리드·레이아웃·정보 구조화·데이터 시각화 | 편집물·인포그래픽 체계 설계 | 편집디자인, 정보디자인 |
| 브랜드·아이덴티티 | 트랙전공 | 브랜드 전략·BI/CI·비주얼 시스템 | 일관된 브랜드 아이덴티티 시스템 구축 | 브랜드디자인, 아이덴티티시스템 |
| 생성형 비주얼·프롬프트 디자인 | 트랙전공 | 프롬프트 기반 이미지·스타일 생성, 무드보드 자동화 | 의도한 톤의 생성형 비주얼 시안 산출 | 생성형비주얼디자인, AI브랜딩워크숍 |
| 시각디자인 캡스톤 | 트랙전공 | 통합 브랜딩·편집 프로젝트·산학 협업 | 컨셉~실물 적용 완성작 산출 | 시각디자인캡스톤 |
