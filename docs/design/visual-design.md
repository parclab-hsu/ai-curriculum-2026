...
## 8. 교육 목표 (예시)
> 학문 분야 정체성: 시각디자인트랙은 타이포그래피·편집·브랜딩·그래픽 커뮤니케이션을 통해 메시지를 시각적으로 구조화하는 분야로, 생성형 AI를 활용해 발상·표현·실행의 효율과 완성도를 높이는 시각 디자이너를 양성합니다.
...
!!! info "진출 직무 — 이런 전문가로 성장할 수 있어요"
    ...
    - **브랜드 디자이너 (경로 A):** 로고·색·서체 같은 브랜드의 얼굴을 창조하고 모든 매체에서 일관되게 보이도록 시스템을 설계하는 전문가입니다. 내가 만든 아이덴티티가 간판·앱·패키지 곳곳에서 사람들 눈에 각인되고 브랜드의 첫인상이 되는 성취를 경험할 수 있습니다. → *AI 활용 능력·역량:* Midjourney 등으로 브랜드 시안을 폭넓게 생성하고 톤에 맞는 방향을 선별·정제하는 **AI 브랜드 아이덴티티 설계 역량**.
    - **편집 디자이너·아트디렉터 (경로 B):** 잡지·책·광고 지면의 글과 이미지를 읽기 좋게 배치하고 촬영·시안 전체의 톤을 지휘하는 비주얼 총괄자입니다. 한 페이지의 여백과 서체까지 내 감각으로 결정하며, 완성된 지면이 작품처럼 남는 보람을 느낄 수 있습니다. → *AI 활용 능력·역량:* 레이아웃·이미지 시안을 자동 생성해 초안을 빠르게 잡고 방향을 비교·발전시키는 **AI 편집·아트디렉션 역량**.
    - **인포그래픽 디자이너·데이터 비주얼라이저 (경로 C):** 복잡한 숫자와 정보를 한눈에 이해되는 그림·차트로 바꿔 전달하는 전문가입니다. 아무도 이해 못 하던 데이터를 내 디자인으로 명쾌하게 풀어내 '아, 그런 거였구나'를 이끌어 내는 성취를 누릴 수 있습니다. → *AI 활용 능력·역량:* 데이터에서 핵심을 요약하고 차트 시안을 도출해 표현을 확장하는 **AI 데이터 시각화 역량**.
    - **프롬프트 디자이너·생성형 UX 설계자 (경로 D):** 화면을 하나하나 그리는 대신, AI가 좋은 결과를 내도록 지시문(프롬프트)과 디자인 규칙·시스템을 설계하는 새 시대의 디자이너입니다. 아직 정착되지 않은 직무를 앞서 개척하며 디자인과 AI의 경계에서 가장 앞선 인재로 성장할 수 있습니다. → *AI 활용 능력·역량:* 프롬프트와 컴포넌트 규칙을 설계해 일관된 화면·에셋이 자동 생성되게 하는 **생성형 UX·디자인 시스템 설계 역량**.

### 10-5. 상위 수준 보완 권고

> 아래는 홍익대 시각디자인·서울대 디자인·국민대 시각디자인 등 시각디자인·브랜딩 특성화 **상위 비교군** 및 산업 표준 정렬을 위한 **보완 권고**입니다. **공식 교과를 대체하지 않으며**, 2027학년도 교과 개편 시 심의 의견·향후 개선 계획으로 활용합니다.
