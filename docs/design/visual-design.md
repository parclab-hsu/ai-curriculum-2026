...
```mermaid
flowchart LR
  M1["① AI 디자인 리터러시<br/>AI와 HCI · 크리에이티브워크숍"] --> CAP
  M2["② 디자인 기초·조형<br/>기초시각디자인 · 타이포그래피 · 구조와 표현"] --> CAP
  M3["③ 디자인 씽킹·UX 리서치<br/>디자인과인간심리 · 사진과디자인 · UXUI디자인 기초"] --> CAP
  M4["④ 편집·정보디자인<br/>인포그래픽 · 레이아웃디자인 · 커뮤니케이션그래픽디자인"] --> CAP
  M5["⑤ 브랜드·아이덴티티<br/>브랜드디자인 · 패키지디자인 · 그래픽디자인"] --> CAP
  M6["⑥ 생성형 비주얼·UX 융합<br/>메타버스와 XR융합콘텐츠 · 모바일인터페이스종합설계 · 제품서비스융합디자인"] --> CAP
  CAP["시각디자인종합설계 · 캡스톤"]
```
