...
```mermaid
flowchart LR
  M1["① AI 핵심·에이전트 기초<br/>인공지능 개론 · 인공지능 수학 · 머신러닝"] --> CAP
  M2["② AI 프로그래밍·데이터<br/>C프로그래밍 · 객체지향프로그래밍 · 데이터베이스"] --> CAP
  M3["③ 물리 AI·로보틱스·임베디드 기초<br/>디지털 논리 및 회로 · 오픈소스 HW · 컴퓨터구조"] --> CAP
  M4["④ 기계공학 핵심<br/>정역학 · 동역학 · 열역학 · 유체역학"] --> CAP
  M5["⑤ 기계설계·제조·CAE<br/>기계요소설계 · CAD·CAM · 유한요소해석"] --> CAP
  M6["⑥ 로봇 제어·로봇러닝·시뮬레이션<br/>딥러닝 · 컴퓨터비전 · 강화학습 · 로보틱스와 인공지능"] --> CAP
  M7["⑦ 로봇 AI 캡스톤<br/>AI프리캡스톤디자인 · 지능시스템 캡스톤디자인"] --> CAP
  CAP["로봇 AI 캡스톤 · 종합설계"]
```
