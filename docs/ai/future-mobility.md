...
```mermaid
flowchart LR
  M1["① AI 핵심·머신러닝<br/>인공지능 및 머신러닝개론 · 실습"] --> CAP
  M2["② 모빌리티 공학·수학 기초<br/>미래모빌리티개론 · 모빌리티 공학수학 · 기초역학"] --> CAP
  M3["③ 전자·컴퓨팅·프로그래밍 기초<br/>C프로그래밍 · 모빌리티 전기전자회로 · 논리회로"] --> CAP
  M4["④ 자율주행 인지·센서<br/>센서처리와 모터제어 · 센서 응용설계 · 자율주행시스템 응용"] --> CAP
  M5["⑤ 제어·임베디드·SDV<br/>모빌리티 제어설계 · 제어공학 · 임베디드시스템"] --> CAP
  M6["⑥ Physical AI·로보틱스·설계<br/>Physical AI 시뮬레이션 · 이동로봇과 ROS · 드론 및 UAM"] --> CAP
  M7["⑦ 모빌리티 종합설계 캡스톤<br/>종합설계 프로젝트 · 스마트모빌리티실증랩"] --> CAP
  CAP["모빌리티 종합설계 프로젝트 · 캡스톤"]
```
