...
| --- | --- | --- | --- | --- |
| AI 핵심·에이전트 기초 | 단과대학공통 | AI/ML 기초, 생성형 AI·RAG·에이전트 기초, MLOps 입문, AI 윤리·거버넌스 | AI 핵심 개념과 에이전트형 AI의 동작 원리를 보안 맥락에서 설명할 수 있다 | AI개론(제안), 생성형AI와에이전트입문(신설 제안), AI윤리와거버넌스(제안) |
| 정보보안 기반 | 학부공통 | 네트워크·시스템·웹·암호 보안, 운영체제 | 보안 위협 모델을 이해하고 기본 방어체계를 구성할 수 있다 | 정보보안개론, 리눅스 시스템, 컴퓨터네트워크, 네트워크 해킹 및 보안, 암호학의 기초, 보안프로그래밍, 역공학분석 |
| 데이터·AI 분석 기초 | 학부공통 | 데이터 처리, 머신러닝 기초, 로그·트래픽 분석 | 보안 데이터를 분석하고 ML 기반 이상탐지를 구현할 수 있다 | 파이썬프로그래밍, 확률 및 통계, 머신러닝(제안), 보안데이터분석(제안) |
| AI 보안·적대적 위협 | 학과전공 | 적대적 공격·방어, 데이터 포이즈닝, 모델 보안 | AI 시스템 고유 위협을 식별하고 방어 기법을 적용할 수 있다 | AI보안(신설 제안), 적대적머신러닝(신설 제안), AI모델보안(신설 제안) |
| LLM 보안·취약점 | 학과전공 | 프롬프트 인젝션, 데이터 유출, LLM 레드팀, 가드레일 | LLM 기반 시스템의 취약점을 점검·완화할 수 있다 | LLM보안(신설 제안), 생성형AI레드팀(신설 제안), AI서비스안전성(신설 제안) |
| 보안 자동화·SOAR | 학과전공 | SIEM·SOAR, 플레이북, AI 에이전트 기반 위협대응 | 탐지·대응을 자동화하는 보안 운영 체계를 구축할 수 있다 | 보안운영자동화(SOAR)(신설 제안), 위협헌팅(신설 제안), AI탐지·대응에이전트(신설 제안) |
| 융합보안 캡스톤 | 학과전공 | 실위협 시나리오 통합 대응, 침해대응·포렌식 | 지능형 위협 대응 보안 시스템을 완성하고 검증할 수 있다 | 융합보안 캡스톤, 디지털포렌식(제안), 침해대응프로젝트(제안) |
