...
```mermaid
flowchart LR
  M1["① AI 핵심·데이터 기초<br/>파이썬프로그래밍 · 확률 및 통계 · 선형대수"] --> CAP
  M2["② 정보보안 기반<br/>정보보안개론 · 리눅스 시스템 · 컴퓨터네트워크"] --> CAP
  M3["③ 암호·보안프로그래밍<br/>암호학의 기초 · 암호학 고급 · 보안프로그래밍"] --> CAP
  M4["④ 웹·시스템 보안·역공학<br/>웹 프로그래밍 · 네트워크 해킹 및 보안 · 역공학분석"] --> CAP
  M5["⑤ AI 보안·LLM 취약점<br/>인공지능 보안 · AI 서비스 엔지니어링 · 적대적머신러닝"] --> CAP
  M6["⑥ 보안 자동화·SOAR<br/>디지털포렌식 · 위협헌팅 · AI탐지대응에이전트"] --> CAP
  M7["⑦ 융합보안 캡스톤<br/>프리캡스톤 디자인 · 개인정보보호 실무 프리인턴십"] --> CAP
  CAP["융합보안 캡스톤 디자인 · 종합설계"]
```
