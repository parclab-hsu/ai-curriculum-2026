...
> 한성대학교 AI융합대학 AI학부 / 2026학년도 AI융합교육과정 개편 리서치 · 작성 기준일: 2026-06-25
...
**AI 융합 개편 방향**: 보안 위협이 **AI 악용(자동화 공격·딥페이크 피싱)**과 **AI 시스템 자체의 취약점(프롬프트 인젝션·데이터 포이즌닝)**으로 동시 확장됨에 따라, "AI를 지키고(AI 시스템 보안) AI로 지키는(AI 활용 보안)" 양방향 역량을 교육 핵심에 둔다.
...
!!! abstract "이 트랙과 향후 10년 고용"
    ...
    - **미국(BLS)·글로벌(WEF):** 디지털 전환으로 컴퓨터·수학 직군이 +10.1% 성장하고, WEF는 AI 기업 86%의 전환과 스킬 39% 진부화로 보안 수요가 확대되는 한편 사무·단순직 감소를 전망한다.
...
| --- | --- | --- | --- | --- |
| AI 핵심·에이전트 기초 | 단과대학공통 | AI/ML 기초, 생성형 AI·RAG·에이전트 기초, MLOps 입문, AI 윤리·거버넌스 | AI 핵심 개념과 에이전트형 AI의 동작 원리를 보안 맥락에서 설명할 수 있다 | AI개론, 생성형AI와에이전트입문, AI윤리와거버넌스 |
| 정보보안 기반 | 학부공통 | 네트워크·시스템·웹·암호 보안, 운영체제 | 보안 위협 모델을 이해하고 기본 방어체계를 구성할 수 있다 | 정보보안개론, 네트워크보안, 시스템·운영체제보안 |
| 데이터·AI 분석 기초 | 학부공통 | 데이터 처리, 머신러닝 기초, 로그·트래픽 분석 | 보안 데이터를 분석하고 ML 기반 이상탐지를 구현할 수 있다 | 데이터분석, 머신러닝, 보안데이터분석 |
| AI 보안·적대적 위협 | 학과전공 | 적대적 공격·방어, 데이터 포이즈닝, 모델 보안 | AI 시스템 고유 위협을 식별하고 방어 기법을 적용할 수 있다 | AI보안, 적대적머신러닝, AI모델보안 |
| LLM 보안·취약점 | 학과전공 | 프롬프트 인젝션, 데이터 유출, LLM 레드팀, 가드레일 | LLM 기반 시스템의 취약점을 점검·완화할 수 있다 | LLM보안, 생성형AI레드팀, AI서비스안전성 |
| 보안 자동화·SOAR | 학과전공 | SIEM·SOAR, 플레이북, AI 에이전트 기반 위협대응 | 탐지·대응을 자동화하는 보안 운영 체계를 구축할 수 있다 | 보안운영자동화(SOAR), 위협헌팅, AI탐지·대응에이전트 |
| 융합보안 캡스톤 | 학과전공 | 실위협 시나리오 통합 대응, 침해대응·포렌식 | 지능형 위협 대응 보안 시스템을 완성하고 검증할 수 있다 | 산학캡스톤디자인, 디지털포렌식, 침해대응프로젝트 |
