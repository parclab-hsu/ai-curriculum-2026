...
| --- | --- | --- | --- | --- |
| AI 핵심·에이전트 기초 | 단과대학 공통 | AI/ML 기초, 생성형 AI·RAG·에이전트, AI 윤리·거버넌스 | 생성형 AI 원리 이해, RAG·에이전트 프로토타입, 창작 저작권·윤리 분석 | AI·머신러닝 입문(제안), 생성형 AI와 에이전트(제안), AI 윤리와 거버넌스(제안) |
| 디지털 콘텐츠·미디어 리터러시 | 학부 공통 | 디지털 미디어 이해, 데이터 리터러시, 콘텐츠 플랫폼 생태계 | 플랫폼 구조 분석, 콘텐츠 데이터 해석 | 미디어와 문화콘텐츠, 문화콘텐츠의 이해, 문화콘텐츠산업의 이해, 콘텐츠 데이터 리터러시(제안) |
| 창작 기초·스토리텔링 | 학부 공통 | 서사 구조, 캐릭터·세계관, 시나리오 작법 | 시놉시스·시나리오 작성, 세계관 설계 | 스토리텔링의 세계, 콘텐츠 자료로서의 문학화서사 읽기, 문학기반 대표 콘텐츠 케이스스터디, 문화 키워드로 읽는 한국 현대사 |
| 스토리텔링 × 생성형 AI 창작 | 학과 전공 | 프롬프트 엔지니어링, 이미지/영상 생성 연출, AI 협업 창작 | 생성형 AI 통합 작품 제작, 프롬프트 기반 연출 제어 | 방송영상 크리에이터의 세계, 디지털콘텐츠 제작의 이해, AI 창작 워크숍(신설 제안), 프롬프트 엔지니어링(신설 제안), 비주얼 스토리텔링(신설 제안) |
| IP 기획·트랜스미디어 | 학과 전공 | IP 발굴·확장, 웹툰↔웹소설↔영상 기획, 글로벌 전략 | 트랜스미디어 기획안 완성, IP 비즈니스 모델 설계 | 디지털콘텐츠기획입문, 세계문학 기반 콘텐츠비평, IP 기획론(제안), 트랜스미디어 스토리텔링(제안) |
| AI 검수·글로벌 로컬라이제이션 | 학과 전공 | AI 번역·작화 검수, 휴먼-인-더-루프 품질관리, 다국어 현지화 | AI 산출물 품질 검수, 현지화 워크플로 운영 | 콘텐츠 로컬라이제이션(신설 제안), AI 품질관리(신설 제안) |
| 콘텐츠 AI 캡스톤 | 학과 전공 | 기획→제작→유통 통합, 산학 IP 프로젝트 | 생성형 AI 기반 IP 제작·발표 | 콘텐츠 캡스톤디자인(제안), 산학 IP 프로젝트(제안) |
