...
> 한성대 AI융합대학 · AI융합학부 / 조사일 2026-06-25 · 미확정값은 **추정** 표기

## 1. 개요

문학문화콘텐츠학과는 스토리텔링·시나리오·IP 기획·웹툰/웹소설·OTT 등 **콘텐츠 창작과 기획**을 다루는 학과다.

**AI 융합 개편 방향:** 생성형 AI가 콘텐츠 기획→작화→번역→유통 전 공정에 침투하면서, 순수 창작 역량에 **프롬프트 엔지니어링·생성형 AI 툴 활용·AI 산출물 검수·데이터 리터러시**를 결합한다. '스토리텔링 × 생성형 AI' 통합 트랙으로 K-콘텐츠 글로벌 확장 시대의 기획·제작 인재를 양성한다.
...
!!! abstract "이 트랙과 향후 10년 고용"
    ...
    - **미국(BLS)·글로벌(WEF):** BLS는 의료속기 -4.9% 등 정형 텍스트 직무의 AI 대체를 보여주고, WEF는 사무·비서·데이터입력을 감소 직무로, 데이터·AI 활용 역량을 성장 영역으로 지목한다. 기업 86%가 생성형 AI 전환을 추진해 콘텐츠 워크플로 자동화가 표준이 된다.
...
- K콘텐츠 매출·수출(전자신문·경향신문) / 2024 웹툰산업 매출(매일타임즈) / K-콘텐츠 펀드(데일리안)
- OTT 점유율(CEOSCOREDAILY) / 네이버웹툰 AI 번역(이슈인사이트) / 카카오 헬릭스(AI타임스) / CJ ENM AI 스튜디오(전자신문)
- 리디 2025 실적 / 네이버웹툰·스쿼드엑스 채용(원티드) / KOCCA 채용정보
...
| --- | --- | --- | --- | --- |
| AI 핵심·에이전트 기초 | 단과대학 공통 | AI/ML 기초, 생성형 AI·RAG·에이전트, AI 윤리·거버넌스 | 생성형 AI 원리 이해, RAG·에이전트 프로토타입, 창작 저작권·윤리 분석 | AI·머신러닝 입문, 생성형 AI와 에이전트, AI 윤리와 거버넌스 |
| 디지털 콘텐츠·미디어 리터러시 | 학부 공통 | 디지털 미디어 이해, 데이터 리터러시, 콘텐츠 플랫폼 생태계 | 플랫폼 구조 분석, 콘텐츠 데이터 해석 | 디지털 미디어론, 콘텐츠 데이터 리터러시 |
| 창작 기초·스토리텔링 | 학부 공통 | 서사 구조, 캐릭터·세계관, 시나리오 작법 | 시놉시스·시나리오 작성, 세계관 설계 | 스토리텔링 기초, 시나리오 작법 |
| 스토리텔링 × 생성형 AI 창작 | 학과 전공 | 프롬프트 엔지니어링, 이미지/영상 생성 연출, AI 협업 창작 | 생성형 AI 통합 작품 제작, 프롬프트 기반 연출 제어 | AI 창작 워크숍, 프롬프트 엔지니어링, 비주얼 스토리텔링 |
| IP 기획·트랜스미디어 | 학과 전공 | IP 발굴·확장, 웹툰↔웹소설↔영상 기획, 글로벌 전략 | 트랜스미디어 기획안 완성, IP 비즈니스 모델 설계 | IP 기획론, 트랜스미디어 스토리텔링 |
| AI 검수·글로벌 로컬라이제이션 | 학과 전공 | AI 번역·작화 검수, 휴먼-인-더-루프 품질관리, 다국어 현지화 | AI 산출물 품질 검수, 현지화 워크플로 운영 | 콘텐츠 로컬라이제이션, AI 품질관리 |
| 콘텐츠 AI 캡스톤 | 학과 전공 | 기획→제작→유통 통합, 산학 IP 프로젝트 | 생성형 AI 기반 IP 제작·발표 | 콘텐츠 캡스톤디자인, 산학 IP 프로젝트 |
