...
```mermaid
flowchart LR
  M1["① 콘텐츠·미디어 리터러시 기초<br/>문화콘텐츠의 이해 · 문화콘텐츠산업의 이해 · 미디어와 문화콘텐츠"] --> CAP
  M2["② 창작 기초·스토리텔링<br/>스토리텔링의 세계 · 고전소설의 스토리텔링 · 디지털스토리텔링 실습"] --> CAP
  M3["③ 문학기반 콘텐츠화<br/>세계문학 기반 콘텐츠비평 · 고전문학의 콘텐츠화 전략 · 현대문학의 콘텐츠화 전략"] --> CAP
  M4["④ 디지털콘텐츠 기획·제작<br/>디지털콘텐츠기획입문 · 디지털콘텐츠 제작툴의 이해 · 방송영상 크리에이터의 세계"] --> CAP
  M5["⑤ 트렌드·마케팅·생성형 AI<br/>문화콘텐츠 트렌드 분석 · 문화콘텐츠 마케팅 · 스마트융합콘텐츠"] --> CAP
  CAP["종합설계 · 캡스톤<br/>지역문화와 콘텐츠 캡스톤 디자인 · 드라마콘텐츠 메이킹실습 · 문화산업과 콘텐츠기획"]
```
