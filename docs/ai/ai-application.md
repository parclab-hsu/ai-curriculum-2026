...
> 본 모듈은 **한성대 공식 교과과정([https://www.hansung.ac.kr/CreCon/2779/subview.do](https://www.hansung.ac.kr/CreCon/2779/subview.do))**을 기본 데이터로 3~4과목 단위로 재구성했다. 공식 목록에 없는 과목은 **(예시)**로 표기. 확인일 2026-06-28.

| 모듈명 | 계층 | 핵심 역량·주제 | 학습 성과 | 대표 교과(공식 3~4과목) |
| --- | --- | --- | --- | --- |
| AI 핵심·수학 기초 | 단과대학공통 | AI 개론, 선형대수·확률통계, AI 수학 | AI 핵심 개념과 수리 토대를 이해·설명할 수 있다 | 인공지능 개론 · 선형대수 · 확률 및 통계 · 인공지능 수학 |
| 프로그래밍·컴퓨팅 기초 | 학부공통 | C·객체지향 프로그래밍, 자료구조·알고리즘 | 자료구조·알고리즘 기반으로 프로그램을 구현할 수 있다 | C프로그래밍 · 객체지향프로그래밍 · 자료구조 및 실습 · 알고리즘 및 실습 |
| 데이터·시스템 엔지니어링 | 학부공통 | 데이터베이스, 컴퓨터구조·운영체제, 클라우드 | 실데이터를 처리하고 시스템·클라우드 기반을 다룰 수 있다 | 데이터베이스 · 컴퓨터구조 · 운영체제 · 클라우드 컴퓨팅 |
| 머신러닝·딥러닝 응용 | 학과전공 | 지도·비지도학습, CNN·RNN·Transformer, 강화학습 | 문제 유형에 맞는 모델을 선택·학습·평가할 수 있다 | 머신러닝 · 딥러닝 · 컴퓨터비전 · 강화학습 |
| 생성형 AI·LLM 솔루션 | 학과전공 | 자연어처리, 시각지능, LLM·RAG 응용 | 도메인 특화 생성형 AI 서비스를 설계·구현할 수 있다 | 자연어처리 · 시각지능 학습 · LLM응용프로그래밍(예시) · RAG시스템설계(예시) |
| AI 응용·임베디드·도메인 | 학과전공 | 임베디드·IoT AI, 로보틱스, 도메인 AI | AI를 임베디드·도메인 서비스로 응용할 수 있다 | 지능형 임베디드 시스템 · 지능형 IoT 통신시스템 · 로보틱스와 인공지능 · 의료 인공지능 |
| 도메인 AI 응용 캡스톤 | 학과전공 | 산업 도메인 문제 정의·솔루션 통합 | 실문제를 해결하는 AI 솔루션을 완성하고 검증할 수 있다 | 기업연계 AI캡스톤디자인 · 인공지능 캡스톤 디자인 · 산학협력프로젝트 · 소프트웨어공학 |
...
flowchart LR
  subgraph Y1["1학년 · 입문"]
    A0["AI 입문<br/>인공지능 개론 · C프로그래밍"]
  end
  subgraph Y2["2학년 · 전공기반"]
    M1["① AI 핵심·수학 기초<br/>선형대수 · 확률 및 통계 · 인공지능 수학"]
    M2["② 프로그래밍·컴퓨팅 기초<br/>객체지향프로그래밍 · 자료구조 및 실습 · 알고리즘 및 실습"]
    M3["③ 데이터·시스템 엔지니어링<br/>데이터베이스 · 운영체제 · 클라우드 컴퓨팅"]
  end
  subgraph Y3["3학년 · 전공심화"]
    M4["④ 머신러닝·딥러닝 응용<br/>머신러닝 · 딥러닝 · 컴퓨터비전 · 강화학습"]
    M5["⑤ 생성형 AI·LLM 솔루션<br/>자연어처리 · 시각지능 학습 · RAG시스템설계"]
    M6["⑥ AI 응용·임베디드·도메인<br/>지능형 임베디드 시스템 · 로보틱스와 인공지능 · 의료 인공지능"]
  end
  subgraph Y4["4학년 · 통합"]
    CAP["도메인 AI 응용 캡스톤<br/>기업연계 AI캡스톤디자인 · 산학협력프로젝트"]
  end
  A0 --> M1
  A0 --> M2
  M1 --> M3
...
| --- | --- | --- |
| AI 핵심·수학 기초 | AI 개론, 선형대수·확률통계, AI 수학 | 통계·수학 기초 |
| 프로그래밍·컴퓨팅 기초 | C·객체지향, 자료구조·알고리즘 | Python, 자료구조·알고리즘, Git·협업 |
| 데이터·시스템 엔지니어링 | 데이터베이스, 컴퓨터구조·OS, 클라우드 | SQL/데이터 처리, Docker/Kubernetes·클라우드 |
| 머신러닝·딥러닝 응용 | 지도·비지도학습, CNN·RNN·Transformer, 강화학습 | 모델 파인튜닝(LoRA/QLoRA), PyTorch/TensorFlow |
| 생성형 AI·LLM 솔루션 | 자연어처리, 시각지능, LLM·RAG 응용 | 생성형 AI 활용·프롬프트, RAG 파이프라인(LangChain·벡터DB) |
| AI 응용·임베디드·도메인 | 임베디드·IoT AI, 로보틱스, 도메인 AI | 도메인 문제 정의·서비스 설계, AI 에이전트 오케스트레이션 |
| 도메인 AI 응용 캡스톤 | 산업 도메인 문제 정의·솔루션 통합 | 서비스 설계, AI 윤리, MLOps 운영 |

### 10-2. 모듈 간 관계 (학과·학부·단과대학)

- **위계 구조**: 단과대학 공통 모듈 「AI 핵심·에이전트 기초」(AI/ML·생성형 AI·MLOps·윤리의 공통 토대) → AI학부 공통(데이터·AI 엔지니어링, 머신러닝·딥러닝 응용) → 학과 전공심화(생성형 AI·LLM 솔루션, AI 에이전트·자동화, MLOps 운영) 순으로 심화된다.
- **선후수 관계**: AI개론·데이터엔지니어링 이수 후 머신러닝·딥러닝을 수강하며, 머신러닝·딥러닝과 생성형 AI 입문을 선수한 뒤 LLM 솔루션·에이전트·MLOps 전공으로 진입한다. 캡스톤은 전공심화 모듈 중 2개 이상 이수를 권장한다.
- **마이크로디그리**: 「생성형 AI·LLM 솔루션」+「AI 에이전트·자동화」 묶음을 '생성형 AI 솔루션 개발자' 마이크로디그리로, 「MLOps·AI 서비스 운영」을 'AI 서비스 엔지니어' 마이크로디그리로 인증 가능하다.
- **타 학과 교차수강**: 융합보안학과의 'AI보안·LLM 취약점' 과목을 교차수강하여 안전한 AI 솔루션 설계 역량을 보강할 수 있고, 단과대학 공통 모듈은 전 학부 공통 트랙으로 상호 인정된다.

### 10-3. 진로 분야별 모듈 조합 가이드

| 진로 분야 | 권장 모듈 조합 | 목표 직무 |
| --- | --- | --- |
| 생성형 AI 서비스 개발 | AI 핵심·에이전트 기초 + 생성형 AI·LLM 솔루션 + AI 에이전트·자동화 | LLM 애플리케이션 개발자, AI 서비스 기획·개발자 |
| AI 엔지니어링·MLOps | 데이터·AI 엔지니어링 + 머신러닝·딥러닝 응용 + MLOps·AI 서비스 운영 | ML 엔지니어, MLOps 엔지니어, AI 플랫폼 엔지니어 |
| 도메인 AI 컨설팅·응용 | 머신러닝·딥러닝 응용 + 생성형 AI·LLM 솔루션 + 도메인 AI 응용 캡스톤 | AI 솔루션 컨설턴트, 도메인 AI 애널리스트 |
