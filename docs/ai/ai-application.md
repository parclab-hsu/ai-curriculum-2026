...
```mermaid
flowchart LR
  M1["① AI 핵심·수학 기초<br/>인공지능 개론 · 선형대수 · 인공지능 수학"] --> CAP
  M2["② 프로그래밍·컴퓨팅 기초<br/>C프로그래밍 · 객체지향프로그래밍 · 자료구조 및 실습"] --> CAP
  M3["③ 데이터·시스템 엔지니어링<br/>데이터베이스 · 운영체제 · 클라우드 컴퓨팅"] --> CAP
  M4["④ 머신러닝·딥러닝 응용<br/>머신러닝 · 딥러닝 · 컴퓨터비전 · 강화학습"] --> CAP
  M5["⑤ 생성형 AI·LLM 솔루션<br/>자연어처리 · 시각지능 학습 · RAG시스템설계"] --> CAP
  M6["⑥ AI 응용·임베디드·도메인<br/>지능형 임베디드 시스템 · 로보틱스와 인공지능 · 의료 인공지능"] --> CAP
  CAP["종합설계 · 캡스톤<br/>기업연계 AI캡스톤디자인 · 인공지능 캡스톤 디자인 · 산학협력프로젝트"]
```
