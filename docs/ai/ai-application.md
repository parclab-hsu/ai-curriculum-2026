...
**AI 융합 개편 방향**: 생성형 AI → 에이전트 AI → Physical AI 패러다임에 맞춰 커리큘럼을 재구성한다. 거시 지표상 국내 AI 역량 요구 기업 비중이 2026년 69%(증가 기울기 최대)에 이르러, "AI를 만드는 사람"보다 **"AI를 잘 쓰는 사람(AI 활용·응용)"** 수요가 폭발적으로 증가. 학과 포지셔닝을 *모델 개발자*가 아닌 **AI 애플리케이션 엔지니어 / AI 솔루션 컨설턴트 / AI 서비스 기획자**로 설정한다.
...
| 기업 | 동향 |
| --- | --- |
| 네이버 | HyperCLOVA X 검색 적용, 통합 AI 에이전트 'Agent N' 전면화. 옥니모달 HyperCLOVA X SEED 오픈소스 |
| 카카오 | AI 에이전트 앱 '카나나' 공개, 온디바이스 '카나나 인 카카오톡' 2026 1분기 출시 예정 |
| 삼성전자 | 멀티모달 '삼성 가우스2', 사내 코딩 어시스턴트 code.i를 DX부문 SW 개발자 약 60% 사용 |
| LG | 하이브리드 AI '엑새원(EXAONE) 4.0', Hugging Face 50만 다운로드. MCP·Function Calling |
...
- 정부 '피지캬 AI 핵심 경쟁력 확보 전략' 및 제4차 지능형로봇 기본계획(2024~2028): 2030년까지 로봇 100만대 투입, 핵심부품 국산화율 80%.
- 기업: 로보티즈 'AI 워커', 뉴로메카 산업용 휴머노이드 '젠(ZEN)'. **2025년이 피지캬 AI 산업 원년**.
...
- 원티드랩 2026 서베이(153개사): 'AI·데이터 활용 역량' 중요 기준 4위(24.2%), 74.5%가 채용 유지·확대, 69.2%가 AI 역량 고려.
...
| --- | --- | --- | --- | --- |
| AI 핵심·에이전트 기초 | 단과대학공통 | AI/ML 기초, 생성형 AI·RAG·에이전트 기초, MLOps 입문, AI 윤리·거버넌스 | AI 핵심 개념을 이해하고 에이전트형 AI의 동작 원리를 설명·시연할 수 있다 | AI개론, 생성형AI와에이전트입문, AI윤리와거버넌스 |
| 데이터·AI 엔지니어링 | 학부공통 | 데이터 수집·전처리·파이프라인, 데이터베이스, 특징공학 | 실데이터를 분석 가능한 형태로 가공하고 파이프라인을 구축할 수 있다 | 데이터엔지니어링, 데이터베이스, 데이터시각화 |
| 머신러닝·딥러닝 응용 | 학부공통 | 지도·비지도학습, CNN·RNN·Transformer 활용 | 문제 유형에 맞는 모델을 선택·학습·평가할 수 있다 | 머신러닝, 딥러닝, 컴퓨터비전 |
| 생성형 AI·LLM 솔루션 | 학과전공 | LLM API, 프롬프트 엔지니어링, RAG, 멀티모달 응용 | 도메인 특화 생성형 AI 서비스를 설계·구현할 수 있다 | LLM응용프로그래밍, RAG시스템설계, 멀티모달AI |
| AI 에이전트·자동화 | 학과전공 | 에이전트 설계, 도구 호출·오케스트레이션, 워크플로우 자동화 | 도구를 사용하는 자율 에이전트 기반 자동화 솔루션을 구축할 수 있다 | AI에이전트설계, 워크플로우자동화, 프롬프트·툴오케스트레이션 |
| MLOps·AI 서비스 운영 | 학과전공 | 모델 배포, CI/CD, 모니터링·재학습, 클라우드 | 모델을 서비스로 배포하고 운영·관리할 수 있다 | MLOps, 클라우드AI서비스, AI시스템운영 |
| 도메인 AI 응용 캡스톤 | 학과전공 | 산업 도메인 문제 정의·솔루션 통합 | 실문제를 해결하는 AI 솔루션을 완성하고 검증할 수 있다 | 산학캡스톤디자인, AI응용프로젝트 |
