...
**AI응용학과**는 LLM·생성형 AI를 실제 서비스·산업 문제에 적용하는 **AI 응용·솔루션 개발 인재**를 양성하는 학과로 정의합니다. 모델을 처음부터 만드는 연구보다, 이미 공개된 파운데이션 모델을 활용해 **RAG·AI 에이전트·MLOps·컴퓨터비전** 기반 서비스를 설계·구축·운영하는 실무 역량에 초점을 둡니다.

**AI 융합 개편 방향**: 생성형 AI → 에이전트 AI → Physical AI 패러다임에 맞춰 커리큘럼을 재구성합니다. 거시 지표상 국내 AI 역량 요구 기업 비중이 2026년 69%(증가세가 가장 가파름)에 이르러, "AI를 만드는 사람"보다 **"AI를 잘 쓰는 사람(AI 활용·응용)"** 수요가 빠르게 늘고 있습니다. 학과 포지셔닝을 *모델 개발자*가 아닌 **AI 애플리케이션 엔지니어 / AI 솔루션 컨설턴트 / AI 서비스 기획자**로 설정합니다.
...
> ⚠ 주의: "Python +527%, AWS +1,778%, RAG +2,047%" 등 스킬 수요 증가율은 **출처가 미국 노동시장 데이터(Stanford AI Index/Lightcast)**이며 한국 공고 수요가 아닙니다. 인용 시 '미국 시장 기준'으로 표기해야 합니다.
...
> 학문 분야 정체성: AI응용학과는 AI/ML 기술을 다양한 산업·서비스 도메인에 적용하여 실질적 문제를 해결하는 'AI를 잘 쓰는' 응용·솔루션 전문가를 양성합니다.

생성형 AI·에이전트 시대에 요구되는 것은 모델을 처음부터 만드는 능력보다, 검증된 AI 구성요소를 조합·튜닝·운영하여 현장 문제를 해결하는 **응용 역량**입니다. 본 학과는 이러한 응용·통합·운영 중심의 전문성을 핵심 정체성으로 삼습니다.
...
> 출처: 한성대학교 AI응용학과 공식 교과과정([https://www.hansung.ac.kr/CreCon/2779/subview.do](https://www.hansung.ac.kr/CreCon/2779/subview.do)) 기준, 확인일 2026-06-30. 구성 교과목 공식, 미존재 보강은 (제안). (전기=전공기초·전필=전공필수·전선=전공선택)
...
| --- | --- | --- | --- | --- | --- | --- |
| **M1** | AI 핵심·수학 기초 | 인공지능 개론(1-1·전기) · 선형대수(1-1·전선) · 확률 및 통계(1-2·전선) · 인공지능 수학(2-1·전필) | AI 개론, 선형대수·확률통계, AI 수학 | AI 핵심 개념과 수리 토대를 이해·설명할 수 있다 | 단과대학 공통·전공기초 | 공식 |
| **M2** | 프로그래밍·컴퓨팅 기초 | C프로그래밍(2-1·전선) · 객체지향프로그래밍(2-2·전선) · 자료구조 및 실습(2-2·전필) · 알고리즘 및 실습(3-1·전선) | C·객체지향 프로그래밍, 자료구조·알고리즘 | 자료구조·알고리즘 기반으로 프로그램을 구현할 수 있다 | 학부 공통·M1과 병렬 | 공식 |
| **M3** | 데이터·시스템 엔지니어링 | 데이터베이스(2-2·전선) · 컴퓨터구조(2-2·전선) · 운영체제(3-2·전선) · 클라우드 컴퓨팅(3-2·전선) | 데이터베이스, 컴퓨터구조·운영체제, 클라우드 | 실데이터를 처리하고 시스템·클라우드 기반을 다룰 수 있다 | 학부 공통·M1·M2→M3 | 공식 |
| **M4** | 머신러닝·딥러닝 응용 | 머신러닝(2-2·전필) · 딥러닝(3-1·전필) · 컴퓨터비전(3-1·전선) · 강화학습(4-2·전선) | 지도·비지도학습, CNN·RNN·Transformer, 강화학습 | 문제 유형에 맞는 모델을 선택·학습·평가할 수 있다 | 학과 전공·M3→M4 | 공식 |
| **M5** | 생성형 AI·LLM 솔루션 | 시각지능 학습(3-2·전선) · 자연어처리(4-1·전선) · LLM응용프로그래밍(제안) · RAG시스템설계(제안) | 자연어처리, 시각지능, LLM·RAG 응용 | 도메인 특화 생성형 AI 서비스를 설계·구현할 수 있다 | 학과 전공·M4→M5 | 공식·제안 |
| **M6** | AI 응용·임베디드·도메인 | 지능형 임베디드 시스템(3-1·전필) · 지능형 IoT 통신시스템(3-2·전선) · 의료 인공지능(3-2·전선) · 로보틱스와 인공지능(4-2·전선) | 임베디드·IoT AI, 로보틱스, 도메인 AI | AI를 임베디드·도메인 서비스로 응용할 수 있다 | 학과 전공·M5→M6 | 공식 |
| **M7** | 도메인 AI 응용 캡스톤 | 기업연계 AI캡스톤디자인(3-2·전필) · 소프트웨어공학(4-1·전필) · 인공지능 캡스톤 디자인(4-1·전필) · 산학협력프로젝트(4-2·전선) | 산업 도메인 문제 정의·솔루션 통합 | 실문제를 해결하는 AI 솔루션을 완성하고 검증할 수 있다 | 학과 전공·M1~M6 종합·검증 | 공식 |
...
| **M5** 생성형 AI·LLM 솔루션 | | | | | | 시각지능 학습 | 자연어처리 · LLM응용프로그래밍(제안) · RAG시스템설계(제안) | |
...
!!! info "진출 직무 — 이런 전문가로 성장할 수 있어요"
    ...
    - **생성형 AI 솔루션 개발자 (경로 A):** 세상에 없던 챗봇·문서요약·검색 도우미를 최신 대형 언어모델(LLM)로 직접 빚어내는 창작자입니다. 내가 붙인 기능이 실제 사용자의 질문에 답하고 "이거 진짜 편하다"는 반응으로 돌아오는 짜릿함을 매일 맛볼 수 있습니다. → *AI 활용 능력·역량:* 회사 자료를 LLM에 연결하는 RAG·프롬프트·에이전트를 설계해 아이디어를 곧바로 작동하는 서비스로 완성하는 **LLM 응용 서비스 개발 역량**.
    - **ML/MLOps 엔지니어 (경로 B):** 수많은 사람이 동시에 쓰는 AI 서비스가 한순간도 멈추지 않고 돌아가게 지키는 든든한 운영의 주역입니다. 내 손을 거친 모델이 안정적으로 살아 움직이며 비즈니스를 떠받치는 신뢰를 직접 만들어 냅니다. → *AI 활용 능력·역량:* 모델을 컨테이너·클라우드에 서빙하고 성능 저하를 감지해 자동 재학습·모니터링으로 이어가는 **AI 모델 운영·배포(MLOps) 역량**.
    - **도메인 AI 솔루션 컨설턴트 (경로 C):** 헬스·금융 현장의 진짜 고민을 듣고 "AI로 이렇게 풀면 됩니다"라고 길을 제시하는 문제 해결사입니다. 기술과 현업을 잇는 다리가 되어, 내 제안이 산업 하나를 바꾸는 보람을 경험할 수 있습니다. → *AI 활용 능력·역량:* 데이터로 문제를 진단하고 LLM·RAG 기반 해법을 기획·검증해 도입까지 이끄는 **AI 솔루션 컨설팅 역량**.
    - **멀티모달·컴퓨터비전 AI 엔지니어 (경로 D):** 글자를 넘어 이미지·영상·음성까지 이해하는, SF 같던 기능을 현실로 만드는 엔지니어입니다. 사진 속 물체를 알아보고 영상을 스스로 설명하는 AI를 세상에 내놓는 성취를 손에 쥘 수 있습니다. → *AI 활용 능력·역량:* 컴퓨터비전·시각언어모델(VLM)로 이미지·영상 인식 서비스를 개발·배포하는 **멀티모달 AI 개발 역량**.

### 10-5. 상위 수준 보완 권고

> 아래는 KAIST AI대학원·서울대 AI·성균관대 AI 등 LLM·생성형 AI 응용 특성화 **상위 비교군** 및 산업 표준 정렬을 위한 **보완 권고**입니다. **공식 교과를 대체하지 않으며**, 2027학년도 교과 개편 시 심의 의견·향후 개선 계획으로 활용합니다.
